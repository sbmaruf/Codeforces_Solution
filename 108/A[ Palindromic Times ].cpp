...
<head>
    ...
    <meta name="X-Csrf-Token" content="2853e234b82e72f4f177d89928d83db9"/>
    ...
    <meta property="og:title" content="Submission #12980213 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="c10660f293cabb0342cd1225c919f21b8e4dca7e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12980213 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2853e234b82e72f4f177d89928d83db9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F108%2Fsubmission%2F12980213">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2853e234b82e72f4f177d89928d83db9'/>
...
int main() {
  ...
  while(1) {
    ...
    if( !b )a++ ;
    a%=24 ;
    //cout << yes( a , 1 )  << " " <<  yes( b , 0 ) << endl ;
    if( yes( a , 1 ) == yes( b , 0 ) ) {
      if( Int(yes( a , 1)) < 24 && Int(yes( b , 1 )) < 60 )
      cout <<yes( a , 1 ) <<":" << yes( b , 1 ) << "\n" ;
      return 0 ;
    }
  }
  return 0 ;
