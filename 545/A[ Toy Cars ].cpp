...
<head>
    ...
    <meta name="X-Csrf-Token" content="111c72b7dfcf767e3c1a82748a3353fc"/>
    ...
    <meta property="og:title" content="Submission #11269322 - Codeforces"/>
    ...
    <title>Submission #11269322 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='111c72b7dfcf767e3c1a82748a3353fc'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F545%2Fsubmission%2F11269322">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='111c72b7dfcf767e3c1a82748a3353fc'/>
    ...
    while(cin >> n ){
        ...
        for( int i = 0 ;i < n ; i++ ){
            for( int j = 0 ;j < n ; j++ ){
                ...
                cin >> tmp ;
                if( tmp == 1 )arr[i] = 1 ;
                else if(tmp == 2 ) arr[j] = 1 ;
                else if( tmp == 3 )arr[i] = 1 , arr[j] = 1 ;
            }
        }
        int cnt = 0 ;
