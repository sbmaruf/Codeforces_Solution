...
<head>
    ...
    <meta name="X-Csrf-Token" content="053790161bf3a9bf7f07cce3b731ec25"/>
    ...
    <meta property="og:title" content="Submission #10047218 - Codeforces"/>
    ...
    <title>Submission #10047218 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='053790161bf3a9bf7f07cce3b731ec25'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F300%2Fsubmission%2F10047218">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='053790161bf3a9bf7f07cce3b731ec25'/>
...
int main()
{
    ...
    while( cin >> n ){
        ...
        rep( i , n ){
            int p ;
            cin >> p ;
            if( p < 0 )V[0].push_back( p );
            else if( p > 0 )V[1].push_back( p ) ;
            else V[2].push_back(0) ;
        }
        if( V[0].size() %2 == 0 ){
