...
<head>
    ...
    <meta name="X-Csrf-Token" content="080aa94138e95d7bbd6e242b87664a31"/>
    ...
    <meta property="og:title" content="Submission #5841084 - Codeforces"/>
    ...
    <title>Submission #5841084 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='080aa94138e95d7bbd6e242b87664a31'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F387%2Fsubmission%2F5841084">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='080aa94138e95d7bbd6e242b87664a31'/>
...
<a href="/profile/_kryptonyte_" title="Newbie _kryptonyte_" class="rated-user user-gray">_kryptonyte_</a>    </td>
    <td>
        <a title="A - George and Sleep" href="/contest/387/problem/A">387A</a>
    ...
    <td>2014-01-30 19:43:55</td>
    <td>2014-01-30 21:47:00</td>
    <td>
...
int main(){
    ...
    cin >> s ;
    int eh = ( s[0]-&#39;0&#39; ) * 10 + ( s[1] - &#39;0&#39; ) ;
    int em = ( s[3]-&#39;0&#39; ) * 10 + ( s[4] - &#39;0&#39; ) ;
