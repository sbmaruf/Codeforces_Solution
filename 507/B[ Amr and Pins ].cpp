...
<head>
    ...
    <meta name="X-Csrf-Token" content="0b33e2f029c07974eb1a166f68788ad5"/>
    ...
    <meta property="og:title" content="Submission #9517561 - Codeforces"/>
    ...
    <title>Submission #9517561 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0b33e2f029c07974eb1a166f68788ad5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F507%2Fsubmission%2F9517561">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0b33e2f029c07974eb1a166f68788ad5'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-01-23 19:16:05</td>
    <td>2015-01-23 21:19:43</td>
    <td>
...
int main(){
    ...
    double r , x1 , y1 , xx , yy ;
    while( cin >> r >> x1 >> y1 >> xx >> yy ){
        ...
        double len = sqrt( (x1-xx)*(x1-xx) + (y1-yy)*(y1-yy) );
        double ans = len/(2*r) ;
