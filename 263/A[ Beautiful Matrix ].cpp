...
<head>
    ...
    <meta name="X-Csrf-Token" content="67a6aafe50e1a104d65050f6a3c102d5"/>
    ...
    <meta property="og:title" content="Submission #7797159 - Codeforces"/>
    ...
    <title>Submission #7797159 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='67a6aafe50e1a104d65050f6a3c102d5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F263%2Fsubmission%2F7797159">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='67a6aafe50e1a104d65050f6a3c102d5'/>
...
int main()
{
    ...
    for( int i = 1 ; i <= 5 ; i++ ){
        for( int j =1 ; j <= 5 ; j++ ){
            cin >> arr[i][j] ;
            if( arr[i][j] == 1 )a.first = i , a.second= j ;
        }
    }
   //cout << a.first << " " << a.second << endl ;
    cout << max( 3 , a.first ) - min( 3 , a.first )  +  max( 3 , a.second ) - min( 3 , a.second )  << endl ;
