...
<head>
    ...
    <meta name="X-Csrf-Token" content="255d225fb47696d1c52f03c8b4baa578"/>
    ...
    <meta property="og:title" content="Submission #8024672 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="2cc5cc0d06ea86a84b1fb909589f595e8f692c26"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #8024672 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='255d225fb47696d1c52f03c8b4baa578'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F294%2Fsubmission%2F8024672">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='255d225fb47696d1c52f03c8b4baa578'/>
...
int main()
{
    ...
    rep( i , m ){
        int a , b ;
        cin >> a >> b ;
        rep(j , b-1 )V[a-1].pb(1) ;
        rep(j , V[a].size()-b )V[a+1].pb(1) ;
        V[a].clear() ;
    }
