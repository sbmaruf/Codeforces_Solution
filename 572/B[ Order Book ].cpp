...
<head>
    ...
    <meta name="X-Csrf-Token" content="a8b05ed6ce15e5c98bab91814111ce5c"/>
    ...
    <meta property="og:title" content="Submission #12660078 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="7673ca965e866995854ed7a8e3a9974d5ceede23"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12660078 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a8b05ed6ce15e5c98bab91814111ce5c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    <div style="float:left;">
            <div><a href="/aimfund2015"><img src="http://assets.codeforces.com/images/aimfund-logo.png" style="width:180px;"/></a></div>
    </div>
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F572%2Fsubmission%2F12660078">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a8b05ed6ce15e5c98bab91814111ce5c'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-08-22 21:05:06</td>
    <td>2015-08-22 21:58:14</td>
    <td>
...
int main() {
  ...
  while( cin >> n >> s ) {
    ...
    vector<pair<long long,long long> > B,S;
    for( int i = 0 ; i < n ; i++ ) {
      char ch ;
      int a , b ;
      cin >> ch >> a >> b ;
    ...
    map<long long,long long>:: iterator it = mp2.begin() ;
    for( int j = 0 ; j< s && it != mp2.end() ; it++ , j++ ){
