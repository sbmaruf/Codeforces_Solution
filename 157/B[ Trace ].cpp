...
<head>
    ...
    <meta name="X-Csrf-Token" content="0e234297e579bd821e4fa3d57eb1ffb4"/>
    ...
    <meta property="og:title" content="Submission #9382323 - Codeforces"/>
    ...
    <title>Submission #9382323 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0e234297e579bd821e4fa3d57eb1ffb4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F157%2Fsubmission%2F9382323">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0e234297e579bd821e4fa3d57eb1ffb4'/>
...
int main() {
    ...
    while( cin >> n ){
        ...
        for( int i = n-1 , l = 0 ; i >=0 ; i-- ){
            if( l%2==0 )ans += (arr[i]*arr[i]) ;
            else ans -= (arr[i]*arr[i]) ;
            l++;

        }
        cout << setprecision(15) << ans*PI << endl ;
    }
