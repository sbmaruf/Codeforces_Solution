...
<head>
    ...
    <meta name="X-Csrf-Token" content="28ef079f978e4801ecff2587f11f4f9f"/>
    ...
    <meta property="og:title" content="Submission #5130260 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="b5751dba8c904b20c40f643dd5bcc79aeda918a7"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #5130260 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='28ef079f978e4801ecff2587f11f4f9f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F355%2Fsubmission%2F5130260">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='28ef079f978e4801ecff2587f11f4f9f'/>
...
int main()
{
    ...
    int n,m;
    cin>>n>>m;
    if(n>1 && m==0){ cout << "No solution" <<endl; return 0; }
    string s;
    s+=(m+48);
    for(int i=0;i<(n-1);i++){
        s+=&#39;0&#39;;
