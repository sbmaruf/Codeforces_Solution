...
<head>
    ...
    <meta name="X-Csrf-Token" content="3b1eff5ff7bfe31fc79af223a164fc9c"/>
    ...
    <meta property="og:title" content="Submission #11033927 - Codeforces"/>
    ...
    <title>Submission #11033927 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3b1eff5ff7bfe31fc79af223a164fc9c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F544%2Fsubmission%2F11033927">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3b1eff5ff7bfe31fc79af223a164fc9c'/>
        ...
        if( k > 0 ) {
            for( int i = 1 ; i < s.size() && k ; i++ ) {
                if( st.find(s[i]) == st.end() ) {
                    st.insert(s[i]) ;
                    string tmp (s.begin()+bc,s.begin()+i) ;
                    V.push_back(tmp) ;
                    k-- ;
                    bc = i  ;
                }
            }
            string tmp (s.begin()+bc,s.end()) ;
            if(V.size() > 0 ) {
                if( tmp == V[V.size()-1] ) {
                } else {
                        V.push_back(tmp);
