...
<head>
    ...
    <meta name="X-Csrf-Token" content="5ad9d4014e4422aa04dade15a31ad05a"/>
    ...
    <meta property="og:title" content="Submission #11359547 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="3920997c6a7a553890d87f94525a8d3a3d813440"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11359547 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5ad9d4014e4422aa04dade15a31ad05a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F547%2Fsubmission%2F11359547">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5ad9d4014e4422aa04dade15a31ad05a'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/547">Problems</a></li>
        <li><a
                                        href="/contest/547/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/547/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/547/status">Status</a></li>
        <li><a
                                        href="/contest/547/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/547/room/1">Room</a></li>
        <li><a
                                        href="/contest/547/standings">Standings</a></li>
        <li><a
                                        href="/contest/547/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - Mike and Feet" href="/contest/547/problem/B">547B</a>
...
int main(){
    ...
    for( int i = 0 ; i < n ; i++ ){
        vis[arr[i].second] = 1 ;
        if( arr[i].second > 0 && vis[arr[i].second-1] ){
            U.Union( arr[i].second-1 , arr[i].second ) ;
        }
        if( arr[i].second < n-1 && vis[arr[i].second+1] ){
            U.Union( arr[i].second , arr[i].second+1 ) ;
        }
        int s = U.sz[U.Find( arr[i].second )] ;
        while( idx <= s )ans[idx++] = arr[i].first ;
