...
<head>
    ...
    <meta name="X-Csrf-Token" content="eefc9119d53fabd8367bd0ab6da13e4c"/>
    ...
    <meta property="og:title" content="Submission #10305383 - Codeforces"/>
    ...
    <title>Submission #10305383 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='eefc9119d53fabd8367bd0ab6da13e4c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F285%2Fsubmission%2F10305383">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='eefc9119d53fabd8367bd0ab6da13e4c'/>
...
int main() {
    ...
    long long sum = 0 ;
    long long p = 1 ;
    for( map<long long , long long>:: iterator a = mp.begin() ; a != mp.end() ; a ++ ){
