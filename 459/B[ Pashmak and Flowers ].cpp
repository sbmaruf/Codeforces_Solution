...
<head>
    ...
    <meta name="X-Csrf-Token" content="b971fa89e0529742e15994a1d4675cee"/>
    ...
    <meta property="og:title" content="Submission #7795793 - Codeforces"/>
    ...
    <title>Submission #7795793 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b971fa89e0529742e15994a1d4675cee'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F459%2Fsubmission%2F7795793">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b971fa89e0529742e15994a1d4675cee'/>
...
int main()
{
    ...
    it1-- ;
    it2  = mp.begin() ;
    if( mp.size() != 1 )cout << ((it1->first) - it2->first ) << " " << (it1->second)*(it2->second) << endl ;
    else {
        cout << ((it1->first) - it2->first ) << " " << (( it1->second) *( it1->second - 1 ))/2   << endl ;
    }
    return  0 ;
