...
<head>
    ...
    <meta name="X-Csrf-Token" content="2757485695efbde6738b709ab0be85ef"/>
    ...
    <meta property="og:title" content="Submission #11272968 - Codeforces"/>
    ...
    <title>Submission #11272968 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2757485695efbde6738b709ab0be85ef'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F168%2Fsubmission%2F11272968">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2757485695efbde6738b709ab0be85ef'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="C - Wizards and Trolleybuses" href="/contest/168/problem/C">168C</a>
...
//    cin.tie(nullptr);
    ...
    while( cin >> n >> a >> d ) {
        ...
        for( int i = 0 ; i < n ; i ++ ) {
            ...
            } else time = sqrt( 2*d/ a ) ;;
            time += arr[i].first ;
            if( time < mn )cout << setprecision(15) <<  mn  << "\n";
            else cout << setprecision(15) <<  time <<"\n" ;
            if( time < mn )mn = mn ;
            else mn = time ;
        }
    }
