...
<head>
    ...
    <meta name="X-Csrf-Token" content="349b44bf695327729fa6c5d5abfaf843"/>
    ...
    <meta property="og:title" content="Submission #11272565 - Codeforces"/>
    ...
    <title>Submission #11272565 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='349b44bf695327729fa6c5d5abfaf843'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F168%2Fsubmission%2F11272565">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='349b44bf695327729fa6c5d5abfaf843'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="D - Wizards and Huge Prize" href="/contest/168/problem/D">168D</a>
...
bool vis[201][201][401] ;

double rec( int idx , int t , int s ){
    if( idx == n )return ( t >= l && s >= 200 ) ;
    if( vis[idx][t][s] == 1 )return dp[idx][t][s] ;
    vis[idx][t][s]  = 1 ;
    double ret = rec(idx+1,t,s)*(1-P[idx]);
    if( a[idx] == -1 )ret += rec( idx+1 , t+1 , s-1 )*P[idx] ;
    else ret += rec( idx+1 , t+1 , min(s+a[idx],400) )*P[idx] ;
    return dp[idx][t][s] = ret ;
}
...
int main() {
    while( cin >> n >> l >> k ) {
        ...
        cout << setprecision(15) << rec( 0 , 0 , k+200 ) << "\n" ;
    }
}
