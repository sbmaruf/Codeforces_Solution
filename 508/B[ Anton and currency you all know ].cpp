...
<head>
    ...
    <meta name="X-Csrf-Token" content="de9d73749c79b28159132d4c38868264"/>
    ...
    <meta property="og:title" content="Submission #9592838 - Codeforces"/>
    ...
    <title>Submission #9592838 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='de9d73749c79b28159132d4c38868264'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F508%2Fsubmission%2F9592838">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='de9d73749c79b28159132d4c38868264'/>
...
int main() {
    ...
    while( cin >>s ) {
        ...
        for( int i = 0 ; i< tmp.size() ; i++ ) {
            if( (tmp[i]-&#39;0&#39;) %2 == 0 && tmp[i] < tmp[s.size()-1] ) {
                swap( s[i] , s[s.size()-1] ) ;
                cout << s << endl ;
                return 0 ;
            }
            if( (tmp[i]-&#39;0&#39;) %2 == 0 )ff1= 1 ;
        }
