...
<head>
    ...
    <meta name="X-Csrf-Token" content="7fae2e403687a1ab18ddbaad43ec10af"/>
    ...
    <meta property="og:title" content="Submission #9581475 - Codeforces"/>
    ...
    <title>Submission #9581475 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7fae2e403687a1ab18ddbaad43ec10af'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F508%2Fsubmission%2F9581475">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7fae2e403687a1ab18ddbaad43ec10af'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-01-27 20:13:59</td>
    <td>2015-01-27 21:56:59</td>
    <td>
...
int main() {
    ...
    while( cin >> n >> m >> k ) {
        ...
        for( int i = 0 ; i < k ; i++ ) {
            ...
            cin >> a >> b ;
            arr[a][b] = 1 ;
            if( arr[a][b] == 1 && arr[a+1][b] == 1 && arr[a][b+1] == 1 && arr[a+1][b+1] == 1 && !f1 ) {
                cout << i+1 << endl ;
                f = 1;
                f1 = 1 ;
            }
            ...
            if( arr[a][b] == 1 && arr[a][b+1] == 1 && arr[a-1][b] == 1 && arr[a-1][b+1] == 1 && !f1 ) {
                cout << i+1 << endl ;
                f = 1 ;
                f1 =1 ;
            }
