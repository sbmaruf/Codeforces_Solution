...
<head>
    ...
    <meta name="X-Csrf-Token" content="9b9bb0f9472becfe9fc3613727b9a26d"/>
    ...
    <meta property="og:title" content="Submission #18330271 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="2762f72c06103897d6d584e81255d2c528867c78"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18330271 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9b9bb0f9472becfe9fc3613727b9a26d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F549%2Fsubmission%2F18330271">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9b9bb0f9472becfe9fc3613727b9a26d'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/549">Problems</a></li>
        <li><a
                                        href="/contest/549/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/549/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/549/status">Status</a></li>
        <li><a
                                        href="/contest/549/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/549/room/1">Room</a></li>
        <li><a
                                        href="/contest/549/standings">Standings</a></li>
        <li><a
                                        href="/contest/549/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Face Detection" href="/contest/549/problem/A">549A</a>
  ...
  for( int i = 0 ; i < n ; i++ ) {
    for( int j = 0 ; j < m ; j++ ) {
      if( i+1 < n && j+1 < m ) {
        string ss = "1111" ;
        int ret = calc(s[i][j]) ;
        if( ret < 4 )ss[ret]=s[i][j] ;

        ret = calc(s[i][j+1]) ;
        if( ret < 4 )ss[ret]=s[i][j+1] ;

        ret = calc(s[i+1][j]) ;
        if( ret < 4 )ss[ret]=s[i+1][j] ;

        ret = calc(s[i+1][j+1]) ;
        if( ret < 4 )ss[ret]=s[i+1][j+1] ;
        if( ss == "face" )cnt ++ ;
      }
    }
  }
