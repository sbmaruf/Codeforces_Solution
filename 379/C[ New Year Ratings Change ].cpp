...
<head>
    ...
    <meta name="X-Csrf-Token" content="ef010a0c1575692695664c959307bb99"/>
    ...
    <meta property="og:title" content="Submission #10734754 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="b8d7fdab78d85e49bea4f2335b9079e566393635"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #10734754 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ef010a0c1575692695664c959307bb99'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F379%2Fsubmission%2F10734754">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ef010a0c1575692695664c959307bb99'/>
...
int main() {
    ...
    while( cin >> n ){
        pair<int,int>arr[n] ;
        rep(i,n)cin>>arr[i].first,arr[i].second=i;
        sort( arr , arr + n ) ;
        set<int>st;
        st.insert( arr[0].first ) ;
        for( int i = 1 ; i < n ;i++ ){
