...
<head>
    ...
    <meta name="X-Csrf-Token" content="888e13d7b3a01061dfde5814ad4c45f1"/>
    ...
    <meta property="og:title" content="Submission #10941933 - Codeforces"/>
    ...
    <title>Submission #10941933 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='888e13d7b3a01061dfde5814ad4c45f1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F540%2Fsubmission%2F10941933">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='888e13d7b3a01061dfde5814ad4c45f1'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-04-30 19:41:00</td>
    <td>2015-04-30 21:39:36</td>
    <td>
...
int main(){
    ...
    int cnt = 0 ;
    for( int i = 0 ;i < n ; i++ ){
        cnt += min( abs(s[i]-s1[i]), abs(min(s[i],s1[i])-&#39;0&#39;)+ abs(max(s[i],s1[i])-&#39;9&#39;)+1 );
    }
    cout << cnt << endl ;
}
