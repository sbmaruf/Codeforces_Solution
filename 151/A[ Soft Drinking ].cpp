...
<head>
    ...
    <meta name="X-Csrf-Token" content="5b650c1353934c06a69770c6e31c7669"/>
    ...
    <meta property="og:title" content="Submission #8017143 - Codeforces"/>
    ...
    <title>Submission #8017143 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5b650c1353934c06a69770c6e31c7669'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F151%2Fsubmission%2F8017143">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5b650c1353934c06a69770c6e31c7669'/>
...
int main()
{
    ...
    cout << min(min(cnt1,cnt2),cnt3)/n<<endl;
    return 0;
}
