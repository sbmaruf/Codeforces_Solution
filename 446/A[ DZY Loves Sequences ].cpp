...
<head>
    ...
    <meta name="X-Csrf-Token" content="c054f7ac44c21c197a00061e88be03e9"/>
    ...
    <meta property="og:title" content="Submission #18647981 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="48b86ff67f8a320ae924cc33eb679867ce1f22f3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18647981 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c054f7ac44c21c197a00061e88be03e9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F446%2Fsubmission%2F18647981">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c054f7ac44c21c197a00061e88be03e9'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2016-06-22 17:25:07</td>
    <td>2016-06-22 17:40:32</td>
    <td>
...
using namespace std ;
#define MAX 100000+5
long long n , arr[MAX] , inc[MAX] , d[MAX];
...
int main(){
  while( cin >> n ) {
    ...
    long long ans = 1 ;
    for( int i = 1 ; i <= n ; i++ ){
      if( arr[i+1]-arr[i-1] > 1 )ans = max( ans , inc[i-1]+1+d[i+1] ) ;
      else ans = max( ans , 1+max(inc[i-1],d[i+1]) ) ;
    }
    cout << ans << "\n" ;
  }
  return 0 ;
