...
<head>
    ...
    <meta name="X-Csrf-Token" content="bf46415d3f6256c5dd1fc04b35d81165"/>
    ...
    <meta property="og:title" content="Submission #17707097 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="19df8195d136e428e6e4da09327c4340191b0d6d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #17707097 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bf46415d3f6256c5dd1fc04b35d81165'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F599%2Fsubmission%2F17707097">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bf46415d3f6256c5dd1fc04b35d81165'/>
...
int main(){
  ...
  while( cin >> d1 >> d2 >> d3 ){
    ...
    ans = min( ans , d1+d1+d2+d2 ) ;
    ans = min( ans , d3+d3+d2+d2 ) ;
    ans = min( ans , d3+d3+d1+d1 ) ;
    cout << ans << "\n" ;
  }
  return 0 ;
}
