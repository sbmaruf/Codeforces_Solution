...
<head>
    ...
    <meta name="X-Csrf-Token" content="0430d73503cc90b4b597c81ac4848646"/>
    ...
    <meta property="og:title" content="Submission #7797101 - Codeforces"/>
    ...
    <title>Submission #7797101 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0430d73503cc90b4b597c81ac4848646'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F144%2Fsubmission%2F7797101">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0430d73503cc90b4b597c81ac4848646'/>
...
int main(){
    ...
    if (p1.second > p2.second ){
        cout << p1.second + (n-p2.second) -2 << endl ;
    }
    else cout << p1.second + (n-p2.second) - 1  << endl ;
