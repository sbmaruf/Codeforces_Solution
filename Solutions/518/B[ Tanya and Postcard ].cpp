...
<head>
    ...
    <meta name="X-Csrf-Token" content="df6839e90a4f1145176b438847588911"/>
    ...
    <meta property="og:title" content="Submission #11320568 - Codeforces"/>
    ...
    <title>Submission #11320568 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='df6839e90a4f1145176b438847588911'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F518%2Fsubmission%2F11320568">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='df6839e90a4f1145176b438847588911'/>
...
int main() {
    ...
    while( cin >> s >> s1 ) {
        ...
        for(int i = 0 ; i < s1.size() ; i++ ) {
            if( s1[i] >=&#39;a&#39; && s1[i] <= &#39;z&#39; )arr[s1[i]-&#39;a&#39;]++;
            else if( s1[i] >=&#39;A&#39; && s1[i] <= &#39;Z&#39; )ARR[s1[i]-&#39;A&#39;]++;
        }
        bool f[2*100000+1]= {0} ;
        for( int i = 0 ; i < s.size() ; i++ ) {
            if( s[i] >= &#39;a&#39; && s[i] <= &#39;z&#39; ) {
                if( arr[s[i]-&#39;a&#39;] )YAY++,arr[s[i]-&#39;a&#39;]--,f[i]=1 ;
            } else if( s[i] >= &#39;A&#39; && s[i] <= &#39;Z&#39; ) {
                if( ARR[s[i]-&#39;A&#39;] )YAY++ ,ARR[s[i]-&#39;A&#39;]--,f[i]=1;
            }
        }
