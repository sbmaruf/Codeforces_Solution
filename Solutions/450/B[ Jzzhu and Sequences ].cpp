...
<head>
    ...
    <meta name="X-Csrf-Token" content="05533792b178ad53f49bd008a9c664d1"/>
    ...
    <meta property="og:title" content="Submission #10705058 - Codeforces"/>
    ...
    <title>Submission #10705058 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='05533792b178ad53f49bd008a9c664d1'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F450%2Fsubmission%2F10705058">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='05533792b178ad53f49bd008a9c664d1'/>
        ...
        for( int i = 0 ; i < N ; i++ ) {
            for( int j = 0 ; j < N ; j++ )
                for( int k = 0 ; k < N ; k++ ) {
                    ...
                    ret.arr[i][j] = ((ret.arr[i][j]%MOD)+MOD)%MOD ;
                }
        }
        return ret ;
    }
