...
<head>
    ...
    <meta name="X-Csrf-Token" content="4e6f90f09821edbda468d4e459af2d7f"/>
    ...
    <meta property="og:title" content="Submission #13561022 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d55afa7cd82a91e53420d94942553a8cee42ef40"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #13561022 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4e6f90f09821edbda468d4e459af2d7f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F586%2Fsubmission%2F13561022">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4e6f90f09821edbda468d4e459af2d7f'/>
...
<a href="/profile/_kryptonyte_" title="Pupil _kryptonyte_" class="rated-user user-green">_kryptonyte_</a>    </td>
    ...
    <td>2015-10-12 12:40:25</td>
    <td>2015-10-12 17:32:32</td>
    <td>
...
int main() {
  ...
  for( int i = 0; i < n ; i++ ){
    for( int j= 0 ; j < n ; j++ ){
      if(  i == j )continue ;
      //cout << i << " " << j << " " ;
      int cal1 = d[i] + sum2[n-2] ;
      //cout << cal1  ;
      if( i > 0 )cal1 = cal1 - sum2[i-1] + sum[i-1] ;

      int cal2 = d[j] + sum2[n-2] ;
      if( j > 0 )cal2 = cal2 - sum2[j-1] + sum[j-1] ;
      //cout << " " << cal2 << endl ;
