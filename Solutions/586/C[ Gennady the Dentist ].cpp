...
<head>
    ...
    <meta name="X-Csrf-Token" content="abe860cafcd48a86dc55764953c67d34"/>
    ...
    <meta property="og:title" content="Submission #13564374 - Codeforces"/>
    ...
    <title>Submission #13564374 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='abe860cafcd48a86dc55764953c67d34'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F586%2Fsubmission%2F13564374">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='abe860cafcd48a86dc55764953c67d34'/>
...
<a href="/profile/_kryptonyte_" title="Pupil _kryptonyte_" class="rated-user user-green">_kryptonyte_</a>    </td>
    ...
    <td>2015-10-12 13:03:56</td>
    <td>2015-10-12 17:33:23</td>
    <td>
...
int main() {
  ...
  for( long long i =0 ; i < n ; i++ ) {
    if(vis[i]) {
      ...
      V.push_back(i) ;
      long long cal = v[i] ;
      for( long long j = i+1 ; j < n && cal > 0 ; j++ ) {
        if( vis[j] ) {
          p[j]-=cal ;
          cal-- ;
          if( p[j] < 0 ) {
