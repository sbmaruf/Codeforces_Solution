...
<head>
    ...
    <meta name="X-Csrf-Token" content="1b825ac69017a7b90ad03465e2ab9eb7"/>
    ...
    <meta property="og:title" content="Submission #18348559 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="e633f8a302dc396a86a649481950709b7d7042e7"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18348559 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1b825ac69017a7b90ad03465e2ab9eb7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F557%2Fsubmission%2F18348559">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1b825ac69017a7b90ad03465e2ab9eb7'/>
...
int main(){
  ...
  while ( cin >> n ) {
    ...
    for( int i = 0 ; i < 3 ; i++ ){
      sum -= p[i].first ;
      cout << min(p[i].second,n-sum) << " " ;
      n-=min(p[i].second,n-sum) ;
    }cout << "\n" ;
  }
  return 0 ;
}
