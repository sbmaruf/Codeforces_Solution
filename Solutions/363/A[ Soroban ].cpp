...
<head>
    ...
    <meta name="X-Csrf-Token" content="7f226263b247bf9e66e1fd151f44751f"/>
    ...
    <meta property="og:title" content="Submission #5088908 - Codeforces"/>
    ...
    <title>Submission #5088908 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7f226263b247bf9e66e1fd151f44751f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F363%2Fsubmission%2F5088908">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7f226263b247bf9e66e1fd151f44751f'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Soroban" href="/contest/363/problem/A">363A</a>
...
int main()
{
    ...
    int l=SZ(s);
    for(int i=l-1;i>=0;i--){
        if(s[i]==&#39;0&#39;)printf("O-|-OOOO\n");
        else if(s[i]==&#39;1&#39;)printf("O-|O-OOO\n");
        else if(s[i]==&#39;2&#39;)printf("O-|OO-OO\n");
        else if(s[i]==&#39;3&#39;)printf("O-|OOO-O\n");
        else if(s[i]==&#39;4&#39;)printf("O-|OOOO-\n");
        else if(s[i]==&#39;5&#39;)printf("-O|-OOOO\n");
        else if(s[i]==&#39;6&#39;)printf("-O|O-OOO\n");
        else if(s[i]==&#39;7&#39;)printf("-O|OO-OO\n");
        else if(s[i]==&#39;8&#39;)printf("-O|OOO-O\n");
        else if(s[i]==&#39;9&#39;)printf("-O|OOOO-\n");
    }
    return 0;
}
