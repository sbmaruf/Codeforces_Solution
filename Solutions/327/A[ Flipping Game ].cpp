...
<head>
    ...
    <meta name="X-Csrf-Token" content="4a949fc8038d6e2a7102aa3ddf68d6fb"/>
    ...
    <meta property="og:title" content="Submission #8017494 - Codeforces"/>
    ...
    <title>Submission #8017494 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4a949fc8038d6e2a7102aa3ddf68d6fb'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F327%2Fsubmission%2F8017494">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4a949fc8038d6e2a7102aa3ddf68d6fb'/>
...
int main()
{
    ...
    for( int i = 0 ; i < n ; i ++ ) {
        for( int j = i ; j < n ; j++ ) {
            int cnt = 0 ;
            for( int k = 0 ; k < n ; k++ ) {
                if( arr[k] == 0 && (k>=i && k<=j))cnt ++ ;
                else if( arr[k] == 1 && !(k>=i && k<=j))cnt++;
            }
            m = max( m , cnt ) ;
        }
    }
