...
<head>
    ...
    <meta name="X-Csrf-Token" content="e058885baca3731e3150e427805f25a7"/>
    ...
    <meta property="og:title" content="Submission #11547958 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="c51fe4fb9749cb6812fe390f0893f5c3729d73cb"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11547958 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e058885baca3731e3150e427805f25a7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F551%2Fsubmission%2F11547958">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e058885baca3731e3150e427805f25a7'/>
...
<tr>
    ...
    <td>
            Contestant:<br/>
<a href="/profile/_kryptonyte_" title="Expert _kryptonyte_" class="rated-user user-blue">_kryptonyte_</a>    </td>
    <td>
    ...
    <td>2015-06-12 19:59:46</td>
    <td>2015-06-12 21:51:33</td>
    <td>
...
int main(){
  ...
  while( cin >> n ){
    ...
    for( int i = 0; i < n ; i++ ){
      int q = s[i] ;
      int ans = n-(upper_bound(v.begin(),v.end(),s[i])-v.begin())+1;
      bounds = equal_range(v.begin(),v.end(),s[i]) ;
      cout << ans << " " ;
    }cout << endl ;
