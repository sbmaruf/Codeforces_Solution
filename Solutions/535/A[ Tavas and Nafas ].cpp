...
<head>
    ...
    <meta name="X-Csrf-Token" content="29d020367d1a21dacca57beb0c37d401"/>
    ...
    <meta property="og:title" content="Submission #10707507 - Codeforces"/>
    ...
    <title>Submission #10707507 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='29d020367d1a21dacca57beb0c37d401'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F535%2Fsubmission%2F10707507">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='29d020367d1a21dacca57beb0c37d401'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-04-14 19:47:50</td>
    <td>2015-04-14 21:42:51</td>
    <td>
...
int main() {
    ...
    string s[] = {"zero","one","two","three","four","five","six","seven","eight","nine","ten","eleven",
                    ...
                    "nineteen" , "twenty" } ;
    string s1[] = { "s" , "s" , "twenty" , "thirty" , "forty" , "fifty" , "sixty" , "seventy" , "eighty" , "ninety" } ;
    int n ;
    cin >> n ;
    if( n<=20 ){
        cout << s[n] << endl ;
