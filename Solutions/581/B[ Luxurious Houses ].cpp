...
<head>
    ...
    <meta name="X-Csrf-Token" content="ece4c104da3b1108ccfd63101b7a361f"/>
    ...
    <meta property="og:title" content="Submission #18330440 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="84348bb3532dc5169deeaa8555e777cf0d0b81ea"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18330440 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ece4c104da3b1108ccfd63101b7a361f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F581%2Fsubmission%2F18330440">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ece4c104da3b1108ccfd63101b7a361f'/>
...
int main() {
  ...
  for( long long i = 0 ; i < n-1 ; i++ ){
    if( M[i+1]<arr[i] )cout << 0 << " " ;
    else cout << M[i]-arr[i]+1 << " " ;
  }cout << "0 \n" ;
  return 0 ;
}
