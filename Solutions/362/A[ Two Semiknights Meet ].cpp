...
<head>
    ...
    <meta name="X-Csrf-Token" content="d5a02d1b4cd06cf9917f076ba2ab7b0d"/>
    ...
    <meta property="og:title" content="Submission #5110901 - Codeforces"/>
    ...
    <title>Submission #5110901 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d5a02d1b4cd06cf9917f076ba2ab7b0d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F362%2Fsubmission%2F5110901">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d5a02d1b4cd06cf9917f076ba2ab7b0d'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Two Semiknights Meet" href="/contest/362/problem/A">362A</a>
...
int main()
{
    ...
    while(cases--)
    {
        ...
        int d1=abs(V[0]-V[2]);
        int d2=abs(V[1]-V[3]);
        if(d1%4==0 && V[1]==V[3])cout<<"YES"<<endl;
        else if(d2%4==0 && V[0]==V[2])cout<<"YES"<<endl;
        else if( d1%4==0 && d2%4==0)cout<<"YES"<<endl;
        else {
            cout<<"NO"<<endl;
        }
        getchar();
