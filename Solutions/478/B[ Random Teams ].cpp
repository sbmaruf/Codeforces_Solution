...
<head>
    ...
    <meta name="X-Csrf-Token" content="771b4a1be9ca5963b6b3b589a5a4b924"/>
    ...
    <meta property="og:title" content="Submission #9827748 - Codeforces"/>
    ...
    <title>Submission #9827748 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='771b4a1be9ca5963b6b3b589a5a4b924'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F478%2Fsubmission%2F9827748">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='771b4a1be9ca5963b6b3b589a5a4b924'/>
...
int main(){
    ...
    while( cin >> n >> m ){
        ...
        if( m == 1 ){
            ...
            long long rem = n%m ;
            long long fmul = rem ;
            long long smul = m-rem ;
            long long fans = fmul*(((grpm+1)*(grpm))/2)+smul*(((grpm)*(grpm-1))/2) ;
            n = n-m+1 ;
            cout << fans << " " << ((n)*(n-1))/2 << endl ;
        }
    }
    return 0 ;
}