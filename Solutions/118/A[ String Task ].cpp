...
<head>
    ...
    <meta name="X-Csrf-Token" content="43ca92969b181fe8bbb8687b643376ae"/>
    ...
    <meta property="og:title" content="Submission #7787774 - Codeforces"/>
    ...
    <title>Submission #7787774 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='43ca92969b181fe8bbb8687b643376ae'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F118%2Fsubmission%2F7787774">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='43ca92969b181fe8bbb8687b643376ae'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2014-09-13 22:02:26</td>
    <td>2014-09-13 22:02:27</td>
    <td>
...
int main(){
    ...
    for( int i = 0 ; i < s.size() ; i++ ){
        ...
        if( s[i] == &#39;y&#39;  || s[i] == &#39;a&#39; ||  s[i] == &#39;e&#39; || s[i] == &#39;i&#39; || s[i] == &#39;o&#39; || s[i] == &#39;u&#39;) continue ;
        else {
            ans += &#39;.&#39;  ;
            ans += s[i] ;
        }
