...
<head>
    ...
    <meta name="X-Csrf-Token" content="0fc0bbdccddd0ad8c8e4abc1f2e1e3e9"/>
    ...
    <meta property="og:title" content="Submission #13180539 - Codeforces"/>
    ...
    <title>Submission #13180539 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0fc0bbdccddd0ad8c8e4abc1f2e1e3e9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F580%2Fsubmission%2F13180539">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0fc0bbdccddd0ad8c8e4abc1f2e1e3e9'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a><sup style='margin-left: 0.25em;font-size: 8px;' title="Virtual participant"><a href='/contest/580/standings/participant/5690719#p5690719'>#</a></sup>    </td>
    ...
    <td>2015-09-23 11:03:00</td>
    <td>2015-09-23 11:13:29</td>
    <td>
...
//    }
    ...
    long long mx = -1 ;
    for( int i = 0 ;i < n ; i++ ){
        long long val = P[i].first+d-1 , ans=n-1 ;
        int l = 0 , r = n-1 , m ;
        while( r-l>=4 ){
            m = (l+r)/2 ;
            if( P[m].first > val ){
