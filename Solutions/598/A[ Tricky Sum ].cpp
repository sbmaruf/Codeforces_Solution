...
<head>
    ...
    <meta name="X-Csrf-Token" content="d1f1e6102bcf78c451104ffdb956e3c8"/>
    ...
    <meta property="og:title" content="Submission #18330000 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="372cf0390d34006ca2e1485226dcdc5ac934bd80"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18330000 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d1f1e6102bcf78c451104ffdb956e3c8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F598%2Fsubmission%2F18330000">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d1f1e6102bcf78c451104ffdb956e3c8'/>
...
int main() {
  ...
  while( t -- ){
    cin >> n ;
    long long pos = lower_bound(V.begin(),V.end(),n)-V.begin() ;
    if( V[pos] != n )pos-- ;
    n = (n*(n+1))/2 ;
    n-=2*B[pos] ;
    cout << n << "\n" ;
