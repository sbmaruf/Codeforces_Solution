...
<head>
    ...
    <meta name="X-Csrf-Token" content="5b9144364a873056874b74bba6e46e49"/>
    ...
    <meta property="og:title" content="Submission #7815092 - Codeforces"/>
    ...
    <title>Submission #7815092 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5b9144364a873056874b74bba6e46e49'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F255%2Fsubmission%2F7815092">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5b9144364a873056874b74bba6e46e49'/>
...
int main(){
    ...
    for( int i = 1 ; i <= n ; i++ ){
        if( i %3 == 1 )f1+=arr[i-1] ;
        else if( i%3 == 2 ) f2+=arr[i-1] ;
        else if( i%3 == 0 ) f3+=arr[i-1] ;
    }
    if( f1 > (max(f2,f3)) )cout << "chest\n" ;
    else if( f2 > (max(f1,f3)) )cout << "biceps\n" ;
    else if( f3 > (max(f1,f2)) )cout << "back\n" ;
