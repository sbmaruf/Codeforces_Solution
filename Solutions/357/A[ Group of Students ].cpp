...
<head>
    ...
    <meta name="X-Csrf-Token" content="b36c07c03ce45a747ff3e4a8848d2549"/>
    ...
    <meta property="og:title" content="Submission #5097391 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="42a27947d9bec541eceeb3775a97adc240e39278"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #5097391 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b36c07c03ce45a747ff3e4a8848d2549'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F357%2Fsubmission%2F5097391">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b36c07c03ce45a747ff3e4a8848d2549'/>
...
int main()
{
    ...
    cin>>l>>r;
    rep_1(i,n+1){
        if(cumL[i]>=l && cumL[i]<=r && (tot-cumL[i])>=l && tot-cumL[i]<=r){
            cout<<i+1<<endl;
            return 0;
        }
    }
