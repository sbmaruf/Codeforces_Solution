...
<head>
    ...
    <meta name="X-Csrf-Token" content="8a93cb40b0b203b4b4af4b547d576770"/>
    ...
    <meta property="og:title" content="Submission #10874114 - Codeforces"/>
    ...
    <title>Submission #10874114 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8a93cb40b0b203b4b4af4b547d576770'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F166%2Fsubmission%2F10874114">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8a93cb40b0b203b4b4af4b547d576770'/>
...
int main(){
    ...
    sort( arr , arr+n , comp ) ;
    cout << upper_bound(arr,arr+n,arr[k-1],comp) - lower_bound(arr,arr+n,arr[k-1],comp) << endl ;
