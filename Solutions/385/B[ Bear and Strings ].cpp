...
<head>
    ...
    <meta name="X-Csrf-Token" content="f55acfa6f66935e29dd1bf4adf8ebe9a"/>
    ...
    <meta property="og:title" content="Submission #11438693 - Codeforces"/>
    ...
    <title>Submission #11438693 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f55acfa6f66935e29dd1bf4adf8ebe9a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F385%2Fsubmission%2F11438693">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f55acfa6f66935e29dd1bf4adf8ebe9a'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - Bear and Strings" href="/contest/385/problem/B">385B</a>
    ...
    <td>2015-06-05 04:24:38</td>
    <td>2015-06-05 04:24:39</td>
    <td>
...
int main() {
    ...
    while( cin >>s ) {
        ...
        for(int i = 0 ; i < s.size() ; i++ ){
            if( s.substr(i,4) == cmp ){
                long long tmp = (s.size()-(i+4)+1) ;
                long long t = ( i-back+1 )  ;
                cnt += tmp * t;
                back = i+1 ;
            }
        }
