...
<head>
    ...
    <meta name="X-Csrf-Token" content="0225725fb935872c85852c9a68deae48"/>
    ...
    <meta property="og:title" content="Submission #12713054 - Codeforces"/>
    ...
    <title>Submission #12713054 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0225725fb935872c85852c9a68deae48'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F376%2Fsubmission%2F12713054">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0225725fb935872c85852c9a68deae48'/>
...
int main() {
  ...
  for( long long i = idx-1 , k = 1 ; i >= 0 ; i-- , k++ ){
    if( s[i] == &#39;=&#39; ) continue ;
    sum1 += (s[i]-&#39;0&#39;)*k ;
  }
  for( long long i = idx+1 , k = 1 ; i < s.size() ; i++ , k++ ){
    if( s[i] == &#39;=&#39; ) continue ;
    sum2 += (s[i]-&#39;0&#39;)*k ;
  }
