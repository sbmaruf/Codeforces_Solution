...
<head>
    ...
    <meta name="X-Csrf-Token" content="642cf600e0caf4bd2cb3e1b3e888996b"/>
    ...
    <meta property="og:title" content="Submission #7943188 - Codeforces"/>
    ...
    <title>Submission #7943188 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='642cf600e0caf4bd2cb3e1b3e888996b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F466%2Fsubmission%2F7943188">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='642cf600e0caf4bd2cb3e1b3e888996b'/>
...
int main(){
    ...
    for( int i = 0 ; i <= n ; i++ ){
        long long int cost = i*a + (int(ceil((n-i)/double(m)))*b) ;
        MIN = min ( cost , MIN ) ;
    }
    cout << MIN <<endl;
