...
<head>
    ...
    <meta name="X-Csrf-Token" content="45e3d43d77b48b03c6ebf702f269d0ba"/>
    ...
    <meta property="og:title" content="Submission #11396922 - Codeforces"/>
    ...
    <title>Submission #11396922 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='45e3d43d77b48b03c6ebf702f269d0ba'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F279%2Fsubmission%2F11396922">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='45e3d43d77b48b03c6ebf702f269d0ba'/>
...
int main() {
    ...
    while( cin >> n  >> t  ) {
        ...
        for(int i = 1 ; i <= n ; i++ ) {
            ...
            if( sum[i] > (t+sum[i-1]) ) continue ;
            f = 0 ;
            int l = i , r = n , mid ;
            while( r-l >= 4 ) {
                mid = (l+r)>>1 ;
                if( sum[mid] == t+sum[i-1] ) {
                    f = 1;
                    mx = max( mx , (mid-i+1) ) ;
                    break ;
                } else if( sum[mid] < t+sum[i-1] ) {
                    l = mid ;
                } else {
                    r = mid ;
                }
