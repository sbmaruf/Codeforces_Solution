...
<head>
    ...
    <meta name="X-Csrf-Token" content="b1c477aede8a3638d5709cf45fd03d2f"/>
    ...
    <meta property="og:title" content="Submission #14055860 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="003933b314948b2589e49344f15ac828d71cd0ea"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #14055860 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b1c477aede8a3638d5709cf45fd03d2f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F592%2Fsubmission%2F14055860">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b1c477aede8a3638d5709cf45fd03d2f'/>
  ...
  for( int i =0 ; i < 8 ; i++ ) {
    for( int j = 0 ; j < 8 ; j++ ) {
      if( s[i][j] == &#39;W&#39;) {
        ...
        if( f ) A= min( A ,  calcW( i, j )) ;
      } else if( s[i][j] == &#39;B&#39; ) {
        bool f = 1 ;
        for( int k = i+1 ; k<8  ; k++ ) {
          if( s[k][j] == &#39;W&#39;)f=0;
        }
        if( f )B = min ( B , calcB( i , j )) ;
      }
    }
  }
  if( A <= B )cout << "A\n" ;
