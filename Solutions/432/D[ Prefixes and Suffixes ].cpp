...
<head>
    ...
    <meta name="X-Csrf-Token" content="a45776ef553fd0342c94f4b28078f0eb"/>
    ...
    <meta property="og:title" content="Submission #11940244 - Codeforces"/>
    ...
    <title>Submission #11940244 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a45776ef553fd0342c94f4b28078f0eb'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F432%2Fsubmission%2F11940244">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a45776ef553fd0342c94f4b28078f0eb'/>
...
int main() {
  ...
  while( cin >> s ) {
    ...
    int cnt = 0 ;
    for( int i = 1; i <100000+1 ; i++ )cnt += (M[i]==1);
    cout << cnt+1 << "\n" ;
    for( map<int,int>::iterator it = mp.begin() ; it != mp.end() ; it++ ){
      if( it->first == 0 )continue ;
      if( M[it->first] )cout << it->first << " " << it->second+1 << "\n" ;
    }
    cout << s.size() << " " << 1 << "\n" ;
