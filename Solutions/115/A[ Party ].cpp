...
<head>
    ...
    <meta name="X-Csrf-Token" content="5b107bee0fe5a1e1ef549a93d397c62e"/>
    ...
    <meta property="og:title" content="Submission #11279935 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d6cb89a8c4fc07c13a48077b2c09b58e1fa23651"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11279935 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5b107bee0fe5a1e1ef549a93d397c62e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F115%2Fsubmission%2F11279935">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5b107bee0fe5a1e1ef549a93d397c62e'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-05-26 17:19:19</td>
    <td>2015-05-26 17:20:51</td>
    <td>
...
int main() {
    ...
    while( cin >> n ) {
        for( int i = 0 ;i < n ; i++ ){
            int tmp ;
            cin >> tmp  ;
            if( tmp != -1 )G[tmp].push_back(i+1) ;
            else rt.push_back(i+1);
        }
        int ans = 0 ;
        for(int i = 0 ; i < rt.size() ; i++ ){
            ans = max( ans , rec(rt[i]) )  ;
        }
        cout << ans << endl ;
    }
    return 0 ;
