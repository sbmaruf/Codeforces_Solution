...
<head>
    ...
    <meta name="X-Csrf-Token" content="755feeaef64ff1ec1f9f79bf970987d8"/>
    ...
    <meta property="og:title" content="Submission #7000013 - Codeforces"/>
    ...
    <title>Submission #7000013 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='755feeaef64ff1ec1f9f79bf970987d8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F443%2Fsubmission%2F7000013">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='755feeaef64ff1ec1f9f79bf970987d8'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - Kolya and Tandem Repeat" href="/contest/443/problem/B">443B</a>
...
int main()
{
    ...
    for( int i = 1 ; i <= l+p-1 ; i++ ) {
        for( int j = i+1 ; j <= l+p ; j++ ) {
            if( (j-i+1) % 2 == 0 ) {
                int mid = (i+j)/2 ;
                int flag = 1 ;
                for( int k = i, q = 1 ; k <= mid ; k++ , q++ ) {
                    if( k > l || mid+q > l )continue ;
                    else if( s[k] == s[mid+q] )continue ;
                    else {
                        flag = 0 ;
                        break ;
                    }
