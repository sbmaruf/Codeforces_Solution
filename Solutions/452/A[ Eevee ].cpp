...
<head>
    ...
    <meta name="X-Csrf-Token" content="27d73ed3ff0b333047b24c1deca83a4f"/>
    ...
    <meta property="og:title" content="Submission #7261992 - Codeforces"/>
    ...
    <title>Submission #7261992 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='27d73ed3ff0b333047b24c1deca83a4f'>&nbsp;</span>
...
<a href="/memsql2014"><img src="http://assets.codeforces.com/images/memsql_logo_small.png"/></a> <span style="position:relative;bottom:20px;left:5px;font-family:Arial;">Start[c]UP 2.0</span>
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F452%2Fsubmission%2F7261992">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='27d73ed3ff0b333047b24c1deca83a4f'/>
...
<a href="/profile/_kryptonyte_" title="Pupil _kryptonyte_" class="rated-user user-green">_kryptonyte_</a>    </td>
    ...
    <td>2014-07-27 21:26:59</td>
    <td>2014-07-27 23:39:58</td>
    <td>
...
int main()
{
    ...
    string s ;
    cin >> s ;
    string q[] = {"vaporeon", "jolteon", "flareon", "espeon", "umbreon", "leafeon", "glaceon", "sylveon"};
    int ans ;
    int M = -100000 ;
    for( int j = 0 ; j < 8 ; j++ ) {
        int cnt = 0  ;
