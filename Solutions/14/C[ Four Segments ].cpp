...
<head>
    ...
    <meta name="X-Csrf-Token" content="e112519039cd175fd85eb27a761b74d4"/>
    ...
    <meta property="og:title" content="Submission #11571552 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="32af180f7c160f8c8545035782ca738b4deb2a07"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11571552 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e112519039cd175fd85eb27a761b74d4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F14%2Fsubmission%2F11571552">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e112519039cd175fd85eb27a761b74d4'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="C - Four Segments" href="/contest/14/problem/C">14C</a>
    ...
    <td>2015-06-13 20:15:18</td>
    <td>2015-06-13 20:15:19</td>
    <td>
...
struct quad{
  ...
  quad(){}
  quad(unsigned long long _x1,unsigned long long _y1,unsigned long long _x2,unsigned long long _y2){
    x1 = _x1 ;
    x2 = _x2 ;
    y1 = _y1 ;
    y2 = _y2 ;
...
unsigned long long dist( quad a ){
...
int main() {
    ...
    for( int i = 0 ; i < n/2; i++ ){
      ...
      //cout << P[i].x2  << " " <<  P[i].y2 << " " <<  P[i].x1 <<" " << P[i].y1<<endl; ;
      P[i+4] = quad( P[i].x2 , P[i].y2, P[i].x1 , P[i].y1 ) ;
    }
    for( int i = 0 ;i < n ; i++ ){
      for( int j = 0 ; j < n ; j ++ ){
        if( i == j )continue ;
        for( int k = 0 ; k < n ; k++ ){
          ...
          for( int l = 0 ; l < n ; l++ ){
            ...
            if( P[i].y1 == P[i].y2 && P[j].y1 == P[j].y2 ){
              if( P[k].x1 == P[k].x2 && P[l].x1 == P[l].x2 ){
                unsigned long long d1 = dist( P[i] );
                unsigned long long d2 = dist( P[j] );
                unsigned long long d3 = dist( P[k] );
                unsigned long long d4 = dist( P[l] );
                unsigned long long d5 = dist( quad(P[i].x1,P[i].y1,P[j].x2,P[j].y2) );
                unsigned long long d6 = dist( quad(P[i].x2,P[i].y2,P[j].x1,P[j].y1) );
                if( d1 == d2 && d3 == d4 && d5 == d6 && d1*d3 > 0 ){
                  if( P[i].x2 == P[k].x1 && P[i].y2 == P[k].y1 ){
                    if( P[k].x2 == P[j].x1 && P[k].y2 == P[j].y1 ){
                      if( P[j].x2 == P[l].x1 && P[j].y2 == P[l].y1 ){
                        if( P[l].x2 == P[i].x1 && P[l].y2 == P[i].y1 ) {
                          cout << "YES\n" ;
                          return 0 ;
                        }
                      }
