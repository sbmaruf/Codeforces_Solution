...
<head>
    ...
    <meta name="X-Csrf-Token" content="6a009ab59570f397f0c47eb564a4ba07"/>
    ...
    <meta property="og:title" content="Submission #9220570 - Codeforces"/>
    ...
    <title>Submission #9220570 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='6a009ab59570f397f0c47eb564a4ba07'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F485%2Fsubmission%2F9220570">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6a009ab59570f397f0c47eb564a4ba07'/>
...
<tr>
    ...
    <td>
            Virtual:<br/>
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a><sup style='margin-left: 0.25em;font-size: 8px;' title="Virtual participant"><a href='/contest/485/standings/participant/3671378#p3671378'>#</a></sup>    </td>
    <td>
...
int main() {
    ...
    while( cin >> n ) {
        ...
        cout << sq( max( abs(X-x) , abs(Y-y) ) ) << endl ;
