...
<head>
    ...
    <meta name="X-Csrf-Token" content="be1394392255326e7cf5db8e7f74e42d"/>
    ...
    <meta property="og:title" content="Submission #12979896 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="dfa9bf81314b08dc17e0466a542b7adfbc2f747a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12979896 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='be1394392255326e7cf5db8e7f74e42d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F143%2Fsubmission%2F12979896">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='be1394392255326e7cf5db8e7f74e42d'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/143">Problems</a></li>
        <li><a
                                        href="/contest/143/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/143/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/143/status">Status</a></li>
        <li><a
                                        href="/contest/143/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/143/room/1">Room</a></li>
        <li><a
                                        href="/contest/143/standings">Standings</a></li>
        <li><a
                                        href="/contest/143/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Help Vasilisa the Wise 2" href="/contest/143/problem/A">143A</a>
...
int main() {
  ...
  for( i = 0 ; i < 1000 ; i++ ) {
    ...
    if( p+s != d1 )continue ;
    if( q+r != d2 )continue ;
    if( p == q || p == r || p == s )continue ;
    if( q == r || q == s  )continue ;
    if( r == s ) continue ;
    if( p > 9 || q >9 || r >9 || s > 9 )continue ;
