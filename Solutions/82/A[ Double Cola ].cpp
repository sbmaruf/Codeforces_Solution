...
<head>
    ...
    <meta name="X-Csrf-Token" content="e1face1a299ebb267926a7a6fd9cfea5"/>
    ...
    <meta property="og:title" content="Submission #7795323 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="2b839bd4cb4ef116cc64ca721ef5a8846f60e22a"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #7795323 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e1face1a299ebb267926a7a6fd9cfea5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    <div style="float:left;">
            <a href="http://www.yandex.com/" style="text-decoration:none;"><img src="http://assets.codeforces.com/images/yandex-algorithm-en-logo.png" style="margin-top:5px;"/></a>
    </div>
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F82%2Fsubmission%2F7795323">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e1face1a299ebb267926a7a6fd9cfea5'/>
...
int main()
{
    ...
    while( 1 ) {
        ...
        if( i> n ) {
            i -= k  ;
            int d = n-i ;
            int m = int(ceil((double)d/(double)j));
            if( m == 0 )cout << "Sheldon\n" ;
            //cout << i <<"  " << d << " " <<  j << " " <<  m << endl;
            if(m == 1 )cout << "Sheldon\n" ;
            else if( m == 2  ) cout << "Leonard\n" ;
            else if( m == 3 )cout << "Penny\n" ;
            else if( m == 4 )cout <<"Rajesh\n" ;
            else if( m == 5 )cout<< "Howard\n" ;
            return 0 ;
        }
    }
    return  0 ;
