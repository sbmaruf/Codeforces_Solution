...
<head>
    ...
    <meta name="X-Csrf-Token" content="84842fb949e9f70c491c0461facf2d86"/>
    ...
    <meta property="og:title" content="Submission #11657253 - Codeforces"/>
    ...
    <title>Submission #11657253 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='84842fb949e9f70c491c0461facf2d86'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F552%2Fsubmission%2F11657253">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='84842fb949e9f70c491c0461facf2d86'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="C - Vanya and Scales" href="/contest/552/problem/C">552C</a>
...
int l ;
vector<long long> V ;
void rec( long long idx , long long left , long long right ){
  if( left > 4000000000 || right > 4000000000 ) return ;
  if( idx == l )return ;
  if( f )return ;
  if( left == right ){
    f = 1 ;
  ...
  rec( idx+1 , left+V[idx] , right ) ;
  rec( idx+1 , left , right+V[idx] ) ;
  rec( idx+1 , left , right ) ;
}
