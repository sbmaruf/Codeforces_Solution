...
<head>
    ...
    <meta name="X-Csrf-Token" content="176caf30d405937cd20902285c695ed2"/>
    ...
    <meta property="og:title" content="Submission #11648225 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="911fa60c5f421300d6efb2daaee4f7ef66a513b8"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11648225 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='176caf30d405937cd20902285c695ed2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F552%2Fsubmission%2F11648225">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='176caf30d405937cd20902285c695ed2'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-06-18 20:45:51</td>
    <td>2015-06-18 21:45:09</td>
    <td>
...
using namespace std ;
long long dp[12][2][2][10];
int l ;
string s ;
long long rec( int idx , int perm , int lead , int  dig )  {
    if( idx == l )return dig ;
    if( dp[idx][perm][lead][dig] != -1 )return dp[idx][perm][lead][dig] ;
    long long ret = 0 ;
    int lim = (perm)?9:s[idx]-&#39;0&#39; ;
    for( int i = 0; i<= lim ; i++ ) {
        if( i == 0 && !lead )ret += rec( idx+1 ,  (i<(s[idx]-&#39;0&#39;)) || perm , 0 , 0 ) ;
        else {
            ret += rec( idx+1 ,  (i<(s[idx]-&#39;0&#39;)) || perm , 1 , dig+1 );
        }
    }
    return  dp[idx][perm][lead][dig] = ret ;
}
