...
<head>
    ...
    <meta name="X-Csrf-Token" content="0d84d5c82c363d02e255d6f5f2b1a288"/>
    ...
    <meta property="og:title" content="Submission #11454009 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d751bcd4f2f298037522ee684b8ac9e49f76fdf3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11454009 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='0d84d5c82c363d02e255d6f5f2b1a288'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F527%2Fsubmission%2F11454009">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='0d84d5c82c363d02e255d6f5f2b1a288'/>
    ...
    while( cin >> w >> h >> n ) {
        ...
        for( int i = 0 ; i< n ; i++ ) {
            ...
            if( ch == &#39;H&#39; ) {
                ...
                auto it = H.insert(a).first;
                int left = *(--it) ;
                it++ ;
                int right = *(++it);
                int cur = left-right ;

                HH.erase( HH.find(cur) ) ;
                ...
                auto it = V.insert(a).first;
                int left = *(--it) ;
                it++ ;
                int right = *(++it);
                int cur = left-right ;

                VV.erase( VV.find(cur) ) ;
            ...
            cout << (long long) *HH.begin() * (long long) (*VV.begin()) << "\n" ;
        }
    }
    return 0 ;
}
