...
<head>
    ...
    <meta name="X-Csrf-Token" content="10a21c8d9a917d7dad1bd4337be64ca5"/>
    ...
    <meta property="og:title" content="Submission #5424000 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="98da9863b6a819b9d1651919102e5b21a5dc7199"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #5424000 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='10a21c8d9a917d7dad1bd4337be64ca5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F373%2Fsubmission%2F5424000">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='10a21c8d9a917d7dad1bd4337be64ca5'/>
...
<a href="/profile/_kryptonyte_" title="Newbie _kryptonyte_" class="rated-user user-gray">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Collecting Beats is Fun" href="/contest/373/problem/A">373A</a>
    ...
    <td>2013-12-13 18:28:23</td>
    <td>2013-12-13 20:16:02</td>
    <td>
...
int main()
{
    ...
    //for( int i = 0 ; i <  10 ; i++ ) cout<<arr[i]<<" " << i << endl;
    for( int i = 0 ; i < 10 ; i++ ){
        if( arr[i] > (2*temp) ){
            //cout<<i<<endl;
