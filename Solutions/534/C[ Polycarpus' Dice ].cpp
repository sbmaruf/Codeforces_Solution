...
<head>
    ...
    <meta name="X-Csrf-Token" content="5b5750ff28191c4e4009ca5e30b11cf3"/>
    ...
    <meta property="og:title" content="Submission #10697603 - Codeforces"/>
    ...
    <title>Submission #10697603 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5b5750ff28191c4e4009ca5e30b11cf3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F534%2Fsubmission%2F10697603">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5b5750ff28191c4e4009ca5e30b11cf3'/>
...
int main(){
    ...
    while( cin >> n >> A ) {
        ...
        rep( i , n ){
            ll ans = 0 ;
            ll rem = sum - arr[i] ;
            if( A > rem ) ans += (A-rem)-1 ;
            if( arr[i] > (A-(n-1))) ans += (arr[i]-(A-(n-1))) ;
            if( i > 0 )cout << " " ;
            cout << ans ;
        }cout << "\n" ;
