...
<head>
    ...
    <meta name="X-Csrf-Token" content="208fc54ab32f8c9e2c4834be6e43e313"/>
    ...
    <meta property="og:title" content="Submission #10677782 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="a1ab5d36d64e15a9b3c1383543b61bbc6899ac77"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #10677782 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='208fc54ab32f8c9e2c4834be6e43e313'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F534%2Fsubmission%2F10677782">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='208fc54ab32f8c9e2c4834be6e43e313'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-04-12 19:58:51</td>
    <td>2015-04-12 21:40:45</td>
    <td>
    ...
    while( cin >> n ) {
        if( n == 1  || n == 2 ) {
            ...
            for( int i = 1 , j = n ; i <= j ; i ++ , j-- ){
                    if( i == j )break ;
                    cout << " " <<  i << " " << j ;
                    //if( abs(i-j) == 1 )cout << "hoy nai" << endl ;
            }cout << endl ;
        } else {
            cout << n << endl ;
            for( int i = 1 ; i <= n/2 ; i++ ) {
                if( i > 1 )cout << " " ;
                cout << i << " " << (n/2+i)  ;
                 //if( abs(i-(n/2+i)) == 1 )cout << "hoy nai" << endl ;
            }
            cout << endl ;
        }
