...
<head>
    ...
    <meta name="X-Csrf-Token" content="908b18ba4910ce95ea72d9f1af5da83b"/>
    ...
    <meta property="og:title" content="Submission #7804768 - Codeforces"/>
    ...
    <title>Submission #7804768 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='908b18ba4910ce95ea72d9f1af5da83b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F352%2Fsubmission%2F7804768">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='908b18ba4910ce95ea72d9f1af5da83b'/>
...
int main()
{
    ...
    if( mp.find(0) == mp.end() )cout << -1 << endl ;
    else if( mp.find(5) == mp.end() )cout << 0 << endl ;
    else if( mp[5] < 9 ) cout << 0 << endl ;
    else {
        while( 1 ) {
            long long a = mp[5]*5 ;
            if( a % 9 == 0 ) {
