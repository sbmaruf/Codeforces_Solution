...
<head>
    ...
    <meta name="X-Csrf-Token" content="f760ef580363ad724fd593778c71fa22"/>
    ...
    <meta property="og:title" content="Submission #12990906 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="c8d2b9b95b140980abd32ffb1bb37393cad5c09e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12990906 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f760ef580363ad724fd593778c71fa22'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F106%2Fsubmission%2F12990906">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f760ef580363ad724fd593778c71fa22'/>
...
int main() {
  ...
  string s ,s1 ,s2  ;
  cin >> s >> s1 >>s2 ;
  if( s1[1] == s[0] && s1[1] != s2[1] ){
    cout << "YES\n" << endl ;
  }else if( s2[1] == s[0] && s2[1] != s1[1] ){
    cout << "NO\n" << endl ;
  }else if( s1[1] != s2[1] ){
    cout << "NO\n" ;
  } else {
