...
<head>
    ...
    <meta name="X-Csrf-Token" content="00f81ceddb7593269ce1f61dab141a73"/>
    ...
    <meta property="og:title" content="Submission #8737826 - Codeforces"/>
    ...
    <title>Submission #8737826 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='00f81ceddb7593269ce1f61dab141a73'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F489%2Fsubmission%2F8737826">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='00f81ceddb7593269ce1f61dab141a73'/>
...
int b , n ;
int dp[100+1][900+1][2];
int rec( int idx , int sum , bool lead ){
    ...
    if( dp[idx][sum][lead] != -1 ) return dp[idx][sum][lead] ;
    int ret = 0 ;
    for( i = i ; i <= 9 ; i++ ){
        ret = rec( idx+1 , i+sum , 0  );
        if( ret ) break ;
    }
    return dp[idx][sum][lead] = ret ;
}

int print( int idx , int sum ,bool  lead ){
    ...
    for(i = i ; i <= 9 ; i++ ){
        if( dp[idx+1][sum+i][lead] == 1 ){
            cout << i ;
            print(idx+1,sum+i ,lead) ;
            break ;
        }
    }
}
int rec1( int idx , int sum , bool lead ){
    ...
    int ret = 0 ;
    for( int i = 9 ; i >= lim ; i-- ){
        ret = rec1( idx+1 , i+sum , lead  );
        if( ret ) break ;
    }
    return dp[idx][sum][lead] = ret ;
}
int print1( int idx , int sum ,bool  lead ){
