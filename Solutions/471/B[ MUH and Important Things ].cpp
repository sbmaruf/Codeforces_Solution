...
<head>
    ...
    <meta name="X-Csrf-Token" content="3e985bfeb5cd597215c84f790ebd08ee"/>
    ...
    <meta property="og:title" content="Submission #9827812 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="44f8fbea052b47a515987e0d4e560b468f098730"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #9827812 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3e985bfeb5cd597215c84f790ebd08ee'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F471%2Fsubmission%2F9827812">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3e985bfeb5cd597215c84f790ebd08ee'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - MUH and Important Things" href="/contest/471/problem/B">471B</a>
...
int main() {
    ...
    while( cin >> n ) {
        ...
        if( cnt >= 2 ) {
            ...
            for( int i = 1 ; i < n ; i++ ) {
                if( arr[i].x == arr[i-1].x && cnt == 0) {
                    cnt ++ ;
                }else if( arr[i].x == arr[i-1].x && cnt == 1 ){
                    swap( arr[i] , arr[i-1] ) ;
                    break ;
                }
            }
