...
<head>
    ...
    <meta name="X-Csrf-Token" content="542e398bf7afcbcf2cb3eb7b1aaa4585"/>
    ...
    <meta property="og:title" content="Submission #7406981 - Codeforces"/>
    ...
    <title>Submission #7406981 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='542e398bf7afcbcf2cb3eb7b1aaa4585'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F456%2Fsubmission%2F7406981">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='542e398bf7afcbcf2cb3eb7b1aaa4585'/>
...
long long int dp[100008] ;
long long int freq[100008] ;
...
long long int rec( int s ){
    ...
    dp[s] = max( rec( s-1 ) , rec( s-2 ) + freq[s]*s ) ;
    return dp[s] ;
}
