...
<head>
    ...
    <meta name="X-Csrf-Token" content="8a596ad51dcc4b689b380a650ffba14b"/>
    ...
    <meta property="og:title" content="Submission #8012766 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="e12463109fb0fb13a3c693c003ef8aac683bfc41"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #8012766 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8a596ad51dcc4b689b380a650ffba14b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F472%2Fsubmission%2F8012766">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8a596ad51dcc4b689b380a650ffba14b'/>
...
<a href="/profile/_kryptonyte_" title="Pupil _kryptonyte_" class="rated-user user-green">_kryptonyte_</a>    </td>
    ...
    <td>2014-09-28 21:41:18</td>
    <td>2014-09-28 23:10:13</td>
    <td>
...
int main()
{
    ...
    string prev = min( s[arr[1]][0],s[arr[1]][1]) ;
    //string prev = s[arr[1]][1] ;

    for(int i=2; i<=n; i++) {

        string nows = s[arr[i]][0] ;
        string nowe = s[arr[i]][1] ;
