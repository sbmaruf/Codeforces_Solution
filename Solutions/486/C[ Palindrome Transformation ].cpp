...
<head>
    ...
    <meta name="X-Csrf-Token" content="5b4ca3325c2cc4255bb61d582d0bef48"/>
    ...
    <meta property="og:title" content="Submission #15964993 - Codeforces"/>
    ...
    <title>Submission #15964993 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5b4ca3325c2cc4255bb61d582d0bef48'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F486%2Fsubmission%2F15964993">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5b4ca3325c2cc4255bb61d582d0bef48'/>
...
int calcStep( int curr , int bc ) {
  ...
  return min( forw , bckw ) ;
}

int calcChar( char curr , char aim ) {
  int forw = 0 , bckw = 0 ;
  char ch = curr ;
  while( curr != aim ) {
    curr ++ ;
...
int main() {
  while( cin >> n >> p ) {
    ...
    s2 = s1 ;
    int pos = p-1 , ansf = 0, ansb = 0 ;
    if( s1[pos] != s1[n-1-pos] ) {
      ansf += calcChar(s1[pos],s1[n-1-pos]) ;
      s1[pos]=&#39;X&#39;;
      s1[n-1-pos]=&#39;X&#39; ;
    }
    int bc = pos ;
    ...
    while( pos != p-1 ) {
      if( s1[pos] != s1[n-1-pos] ) {
        ansf += min(calcStep(pos,bc),calcStep(n-1-pos,bc)) ;
        bc = pos ;
        ansf += calcChar(s1[pos],s1[n-1-pos]) ;
        s1[pos]=&#39;X&#39;;
        s1[n-1-pos]=&#39;X&#39; ;
    ...
    pos = p-1 , ansb = 0 ;
    if( s1[pos] != s1[n-1-pos] ) {
      ansb += calcChar(s1[pos],s1[n-1-pos]) ;
      s1[pos]=&#39;X&#39;;
      s1[n-1-pos]=&#39;X&#39; ;
    }
    bc = pos ;
    ...
    while( pos != p-1 ) {
      if( s1[pos] != s1[n-1-pos] ) {
        ansb += min(calcStep(pos,bc),calcStep(n-1-pos,bc)) ;
        bc = pos ;
        ansb += calcChar(s1[pos],s1[n-1-pos]) ;
        s1[pos]=&#39;X&#39; ;
        s1[n-1-pos]=&#39;X&#39; ;
