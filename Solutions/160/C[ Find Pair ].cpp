...
<head>
    ...
    <meta name="X-Csrf-Token" content="f621dff97d2daa7096ce319604adaac6"/>
    ...
    <meta property="og:title" content="Submission #20828549 - Codeforces"/>
    ...
    <title>Submission #20828549 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='f621dff97d2daa7096ce319604adaac6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F160%2Fsubmission%2F20828549">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='f621dff97d2daa7096ce319604adaac6'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="C - Find Pair" href="/contest/160/problem/C">160C</a>
...
int main() {
  ...
  while(cin >> n >> k ) {
    ...
    for( auto i = mp.begin() ; i != mp.end() ; i++ ){
      long long temp = i->second*n ;
      bool f = 0 ;
      if( temp+kk >= k ){
        a = i->first ;
        long long kkk = 0 ;
        for( auto j = mp.begin() ; j != mp.end() ; j++ ){
          long long temp2 = i->second*j->second ;
          if( kkk+temp2 >= k-kk ){
            b = j->first ;
            f = 1 ;
            break ;
