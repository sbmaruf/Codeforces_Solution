...
<head>
    ...
    <meta name="X-Csrf-Token" content="bf87e4fa5f0825311e1af7dfec334f33"/>
    ...
    <meta property="og:title" content="Submission #18329744 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="f336ffd3d387361cf1f592c99e50431b9987b0bd"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18329744 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='bf87e4fa5f0825311e1af7dfec334f33'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F558%2Fsubmission%2F18329744">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='bf87e4fa5f0825311e1af7dfec334f33'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2016-06-08 22:52:15</td>
    <td>2016-06-08 22:52:16</td>
    <td>
...
int main() {
  ...
  deque<pair<long long,long long> >pos,neg ;
  deque<pair<long long,long long> >pos1,neg1 ;
  ...
  for( long long i = 0 ; i < n ; i++ ) {
    long long x , t ;
    cin >> x >> t ;
    if( x < 0 )neg.push_back({abs(x),t}) ;
    else pos.push_back({abs(x),t}) ;
  }
