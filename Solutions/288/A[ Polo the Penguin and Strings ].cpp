...
<head>
    ...
    <meta name="X-Csrf-Token" content="736e140470795fae09f527c4a78a3b81"/>
    ...
    <meta property="og:title" content="Submission #10705344 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="7db71d096f0e2cd47238f43866ad28e475ca1742"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #10705344 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='736e140470795fae09f527c4a78a3b81'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F288%2Fsubmission%2F10705344">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='736e140470795fae09f527c4a78a3b81'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/288">Problems</a></li>
        <li><a
                                        href="/contest/288/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/288/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/288/status">Status</a></li>
        <li><a
                                        href="/contest/288/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/288/room/1">Room</a></li>
        <li><a
                                        href="/contest/288/standings">Standings</a></li>
        <li><a
                                        href="/contest/288/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Polo the Penguin and Strings" href="/contest/288/problem/A">288A</a>
...
int main() {
    ...
    arr[1] += tmp/2 ;
    if( arr[0] == arr[1] ){
        for( int i = 0 ; i < arr[0] ; i++ )cout << "ab" ;
    }else {
        for( int i = 0 ; i < arr[1] ; i++ )cout << "ab" ;
        cout << "a" ;
    }
    for(int i = 2 ; i < b ; i++ ){
        cout << char(&#39;a&#39;+i) ;
