...
<head>
    ...
    <meta name="X-Csrf-Token" content="7baf6c0fbbaee713973bdac11284d141"/>
    ...
    <meta property="og:title" content="Submission #11528743 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="6e04ba8584f5dc66c86e6c06ba8bd053e7bfeda3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11528743 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7baf6c0fbbaee713973bdac11284d141'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F498%2Fsubmission%2F11528743">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7baf6c0fbbaee713973bdac11284d141'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/498">Problems</a></li>
        <li><a
                                        href="/contest/498/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/498/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/498/status">Status</a></li>
        <li><a
                                        href="/contest/498/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/498/room/1">Room</a></li>
        <li><a
                                        href="/contest/498/standings">Standings</a></li>
        <li><a
                                        href="/contest/498/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Crazy Town" href="/contest/498/problem/A">498A</a>
...
int main() {
    ...
    for( int i = 0 ; i < n ; i++ ) {
        ...
        long long ff = a*x2 + b*y2 + c ;
        if( f > 0 && ff < 0 )cnt ++ ;
        else if( ff > 0 && f < 0 )cnt ++ ;
    }
    cout << cnt << endl ;
