...
<head>
    ...
    <meta name="X-Csrf-Token" content="ea953e7af0f9203449b6632bd8871f0a"/>
    ...
    <meta property="og:title" content="Submission #12709496 - Codeforces"/>
    ...
    <title>Submission #12709496 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ea953e7af0f9203449b6632bd8871f0a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F556%2Fsubmission%2F12709496">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ea953e7af0f9203449b6632bd8871f0a'/>
...
int main() {
  ...
  while( cin >> n ) {
    ...
    cout << s.size()-2*min( cnt1 , cnt2 ) << endl ;
  }
  return 0 ;
}
