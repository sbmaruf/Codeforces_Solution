...
<head>
    ...
    <meta name="X-Csrf-Token" content="fe7e960853dfdc2681c1ad02325deed9"/>
    ...
    <meta property="og:title" content="Submission #18294854 - Codeforces"/>
    ...
    <title>Submission #18294854 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='fe7e960853dfdc2681c1ad02325deed9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F509%2Fsubmission%2F18294854">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='fe7e960853dfdc2681c1ad02325deed9'/>
...
int main() {
    ...
    for( int i = 0 ; i < n ; i++ ) {
        cin >> arr[i] ;
        for( int j = 0 , col = 1  ; j < arr[i] ; j++ , col++ ) {
            if( col > k ) col = 1 ;
            dist[i][j] = col ;
        }
    }
