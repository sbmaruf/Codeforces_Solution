...
<head>
    ...
    <meta name="X-Csrf-Token" content="b4da08232e9f64b66835c8881f93cfdc"/>
    ...
    <meta property="og:title" content="Submission #9827827 - Codeforces"/>
    ...
    <title>Submission #9827827 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b4da08232e9f64b66835c8881f93cfdc'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F462%2Fsubmission%2F9827827">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b4da08232e9f64b66835c8881f93cfdc'/>
...
int main() {
    ...
    while( cin >> n >> k ) {
        ...
        map<char,long long >:: iterator it  = mp.end() ;
        vector<data> V ;
        while( it != mp.begin() ) {
            it-- ;
