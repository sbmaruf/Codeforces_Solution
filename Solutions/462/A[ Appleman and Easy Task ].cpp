...
<head>
    ...
    <meta name="X-Csrf-Token" content="83d0328048b17e651f5e7788b09fd550"/>
    ...
    <meta property="og:title" content="Submission #7715524 - Codeforces"/>
    ...
    <title>Submission #7715524 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='83d0328048b17e651f5e7788b09fd550'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F462%2Fsubmission%2F7715524">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='83d0328048b17e651f5e7788b09fd550'/>
...
int main() {
    ...
    for( int i = 0 ; i < n ; i++ ) {
        for( int j = 0 ; j < n ; j++ ) {
            int cnt = 0 ;
            if( i-1 >= 0 ) if( s[i-1][j] == &#39;o&#39; ) cnt++ ;
            if( i+1 <= n-1 ) if( s[i+1][j] == &#39;o&#39; ) cnt++ ;
            if( j+1 <= n-1 ) if( s[i][j+1] == &#39;o&#39; ) cnt++ ;
            if( j-1 >= 0 ) if( s[i][j-1] == &#39;o&#39; ) cnt++ ;
            if( cnt & 1 ) {
                cout << "NO" << endl ;
                return 0 ;
