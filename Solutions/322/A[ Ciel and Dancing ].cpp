...
<head>
    ...
    <meta name="X-Csrf-Token" content="7655f37ecb450982f985ab3105124d3f"/>
    ...
    <meta property="og:title" content="Submission #9827722 - Codeforces"/>
    ...
    <title>Submission #9827722 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7655f37ecb450982f985ab3105124d3f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F322%2Fsubmission%2F9827722">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7655f37ecb450982f985ab3105124d3f'/>
