...
<head>
    ...
    <meta name="X-Csrf-Token" content="e895c03661f810528ade515b11944b51"/>
    ...
    <meta property="og:title" content="Submission #5521324 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="ed56073cc5e83ad5836073f723b38cb9dfecca10"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #5521324 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e895c03661f810528ade515b11944b51'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F371%2Fsubmission%2F5521324">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e895c03661f810528ade515b11944b51'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2013-12-26 00:46:35</td>
    <td>2013-12-26 00:46:36</td>
    <td>
...
bool ok ( i64 cnt ){
    ...
    i64 bread = max ( cnt * B - SB , (long long )0 ) ;
    i64 sausage = max ( cnt * S - SS  , ( long long )0 ) ;
    i64 cheese = max (cnt * C - SC , (long long ) 0 );

    i64 t = tot - bread * CB - sausage * CS - cheese * CC ;
    if( t >= 0 )return 1 ;
    else return 0 ;
...
int main()
{
    ...
    //tot += SB * CB + SS * CS + SC * CC ;

    ui64 l = 0 ;
    ui64 r = 1000000000000000;
    ui64 m ;
