...
<head>
    ...
    <meta name="X-Csrf-Token" content="3c9173a3bcd0ed77ec43d62a3035ffc2"/>
    ...
    <meta property="og:title" content="Submission #7795587 - Codeforces"/>
    ...
    <title>Submission #7795587 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='3c9173a3bcd0ed77ec43d62a3035ffc2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F112%2Fsubmission%2F7795587">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='3c9173a3bcd0ed77ec43d62a3035ffc2'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2014-09-14 19:42:22</td>
    <td>2014-09-14 20:01:53</td>
    <td>
...
int main()
{
    ...
    for( int i = 0 ; i< s.size() ; i++ ){
        if( toupper( s[i] ) < toupper( s1[i] ) ){
            cout << -1 << endl ;
            return  0 ;

        }else if( toupper( s[i] ) > toupper( s1[i] ) ) {
            cout << 1 << endl;
            return 0 ;
        };
    }
