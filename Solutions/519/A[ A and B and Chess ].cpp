...
<head>
    ...
    <meta name="X-Csrf-Token" content="4a1e2d30bfadd51bffc6586f57ffe079"/>
    ...
    <meta property="og:title" content="Submission #10254552 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="cb81525868a449b55e8d2ca98978b9d40844bad1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #10254552 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4a1e2d30bfadd51bffc6586f57ffe079'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F519%2Fsubmission%2F10254552">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4a1e2d30bfadd51bffc6586f57ffe079'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-03-13 10:20:33</td>
    <td>2015-03-13 10:20:48</td>
    <td>
...
int main() {
    ...
    for( int i = 0 ; i < 8 ; i++ ){
        for( int j = 0 ; j < 8 ; j++ ){
            if( s[i][j] == &#39;Q&#39; ) white += 9 ;
            else if( s[i][j] == &#39;R&#39; )white += 5 ;
            else if( s[i][j] == &#39;B&#39; )white += 3 ;
            else if( s[i][j] == &#39;N&#39; )white += 3 ;
            else if( s[i][j] == &#39;P&#39; )white += 1 ;
            else if( s[i][j] == &#39;q&#39; )black += 9 ;
            else if( s[i][j] == &#39;r&#39; )black += 5 ;
            else if( s[i][j] == &#39;b&#39; )black += 3 ;
            else if( s[i][j] == &#39;n&#39; )black += 3 ;
            else if( s[i][j] == &#39;p&#39; )black += 1 ;
        }
    }
