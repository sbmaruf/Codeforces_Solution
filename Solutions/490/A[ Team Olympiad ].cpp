...
<head>
    ...
    <meta name="X-Csrf-Token" content="38a0041ea54ef94d9d84da177c8e69d4"/>
    ...
    <meta property="og:title" content="Submission #9200748 - Codeforces"/>
    ...
    <title>Submission #9200748 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='38a0041ea54ef94d9d84da177c8e69d4'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F490%2Fsubmission%2F9200748">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='38a0041ea54ef94d9d84da177c8e69d4'/>
...
int main(){
    ...
    while( cin >> n ){
        ...
        cout << min( min( mp[1]  , mp[2] ) , mp[3] ) << endl ;
        while( V[1].size()>0 && V[2].size()>0 && V[3].size()>0 ){
            cout << V[1][V[1].size()-1] << " " << V[2][V[2].size()-1] << " " <<  V[3][V[3].size()-1] << endl ;
            V[1].pop_back() ;
            V[2].pop_back() ;
            V[3].pop_back() ;
        }
