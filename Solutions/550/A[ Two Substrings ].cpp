...
<head>
    ...
    <meta name="X-Csrf-Token" content="2906c0c36ebaad3afdc89521586f3520"/>
    ...
    <meta property="og:title" content="Submission #18341130 - Codeforces"/>
    ...
    <title>Submission #18341130 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2906c0c36ebaad3afdc89521586f3520'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F550%2Fsubmission%2F18341130">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2906c0c36ebaad3afdc89521586f3520'/>
...
int main() {
  ...
  while(cin >> s) {
    ...
    //cout << ab << " " << ba << " " << conf << endl;
    if( ab >= 1 && conf >= 1 )cout << "YES\n" ;
    else if( ba >= 1 && conf >= 1 )cout << "YES\n" ;
    else if( ab >= 1 && ba >= 1 )cout << "YES\n" ;
    else if( conf >= 2 )cout <<"YES\n" ;
    else cout << "NO\n" ;
  }
