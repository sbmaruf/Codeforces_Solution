...
<head>
    ...
    <meta name="X-Csrf-Token" content="4ff9f450c139344f738e694336ac2410"/>
    ...
    <meta property="og:title" content="Submission #11439997 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="909d1490490eecf249cff79cfd6873eb21b9a61f"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11439997 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='4ff9f450c139344f738e694336ac2410'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F550%2Fsubmission%2F11439997">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='4ff9f450c139344f738e694336ac2410'/>
...
//string ans,s ;
//int l ;
//int rec( int idx , int mod , bool ok ){
//    //cout << ans << endl ;
//    if( idx == l ) return mod == 0 && ok ;
//    if( dp[idx][mod][ok] != -1 )return dp[idx][mod][ok] ;
//    int f = rec( idx + 1 , mod , 0 ) ;
//    int ff = rec( idx + 1 , (mod*10+s[idx]-&#39;0&#39;)%8 , 1 ) ;
//    if( ff ){
//        ans += s[idx] ;
//    }
//    f = f || ff ;
//    return dp[idx][mod][ok] = f ;
//}
