...
<head>
    ...
    <meta name="X-Csrf-Token" content="a17aaf2d7b0671fcb0300cce90627e3d"/>
    ...
    <meta property="og:title" content="Submission #8023909 - Codeforces"/>
    ...
    <title>Submission #8023909 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a17aaf2d7b0671fcb0300cce90627e3d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F275%2Fsubmission%2F8023909">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a17aaf2d7b0671fcb0300cce90627e3d'/>
...
int main()
{
    rep(i , 6 )rep(j, 6 )sol[i][j] = 1 ;
    rep_1( i , 4 )rep_1( j , 4 )cin >> arr[i][j]  ;
    rep_1( i , 4 )rep_1( j , 4 ) {
        rep ( k , arr[i][j] ){
            sol[i-1][j] ^= 1;
            sol[i][j-1] ^= 1;
