...
<head>
    ...
    <meta name="X-Csrf-Token" content="adf7459f3c269c87f7c3b7df5f33ca72"/>
    ...
    <meta property="og:title" content="Submission #12827386 - Codeforces"/>
    ...
    <title>Submission #12827386 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='adf7459f3c269c87f7c3b7df5f33ca72'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F259%2Fsubmission%2F12827386">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='adf7459f3c269c87f7c3b7df5f33ca72'/>
...
bool test(int i) {
    arr[1][1] = i ;
    int sum1 = arr[1][1] + arr[1][2] + arr[1][3] ;
    int sum2 = arr[1][1] + arr[2][1] + arr[3][1] ;
    if( sum1 != sum2 ) return 0 ;
    int dg2 = sum1 - arr[1][2] - arr[3][2] ;
    arr[2][2] = dg2 ;
    if( (arr[2][1] + arr[2][2] + arr[2][3] ) != sum1 )return 0 ;
    int dg3 = sum1 - arr[1][3] - arr[2][3] ;
    arr[3][3] = dg3 ;
    if( (arr[3][1]+arr[3][2]+arr[3][3])!=sum2 )return 0 ;
    if( arr[1][1] + arr[2][2] + arr[3][3] != sum1 ) return 0 ;
    arr[2][2] = dg2 ;
    arr[3][3] = dg3 ;
    if( arr[1][1] < 0 || arr[2][2] < 0 || arr[3][3] < 0 )return 0 ;
    return 1 ;
}
int main() {
    for( int i = 1 ; i <= 3 ; i++ ) {
