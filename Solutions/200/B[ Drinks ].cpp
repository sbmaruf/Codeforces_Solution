...
<head>
    ...
    <meta name="X-Csrf-Token" content="fc2a8183f7c1d9d6b002849f8c1ad103"/>
    ...
    <meta property="og:title" content="Submission #7994913 - Codeforces"/>
    ...
    <title>Submission #7994913 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='fc2a8183f7c1d9d6b002849f8c1ad103'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F200%2Fsubmission%2F7994913">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='fc2a8183f7c1d9d6b002849f8c1ad103'/>
...
int main()
{
    ...
    for( int i = 0 ; i< n ; i++ ){
        ans += ( arr[i]/100 ) ;
        //cout << ans << " " << arr[i]/m << endl ;
    }
    cout << setprecision(10) << (ans*100)/double(n) << endl ;
