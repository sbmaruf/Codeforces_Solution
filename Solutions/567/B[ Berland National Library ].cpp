...
<head>
    ...
    <meta name="X-Csrf-Token" content="a56d2487a1f1982624baaaa8e5b1e005"/>
    ...
    <meta property="og:title" content="Submission #19035970 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="12f61090280e1eaa8c859b4e4ca10342277ee03d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #19035970 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a56d2487a1f1982624baaaa8e5b1e005'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F567%2Fsubmission%2F19035970">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a56d2487a1f1982624baaaa8e5b1e005'/>
  ...
  while( cin >> n ){
    ...
    for( int i = 0 ; i < n ; i++ ){
      if( V[i].first == &#39;+&#39; ) {
        ...
        mp1.erase(V[i].second) ;
      }
      mx = max( mx , (int)mp1.size() ) ;
    }
    cout << mx << "\n" ;
  }
  return 0 ;
