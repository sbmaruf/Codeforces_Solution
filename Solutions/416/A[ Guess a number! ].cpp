...
<head>
    ...
    <meta name="X-Csrf-Token" content="c8e1db5afa30627447a08231961ab0d9"/>
    ...
    <meta property="og:title" content="Submission #12985245 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="8b88927bb23e4dbfe9ad6d213e140dddc536fae2"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12985245 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c8e1db5afa30627447a08231961ab0d9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F416%2Fsubmission%2F12985245">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c8e1db5afa30627447a08231961ab0d9'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Guess a number!" href="/contest/416/problem/A">416A</a>
...
int main() {
  ...
  while( cases -- ) {
    ...
    if ( lo > hi && lo != (2000000000) && hi != (-2000000000) ) {
      cout << "Impossible\n" ;
      return 0 ;
    }
    if( lo < -2*1000000000 || lo > 2*1000000000 || hi < -2*1000000000 || hi > 2*1000000000 ){
      cout <<"Impossible\n";
      return 0 ;
    }
  ...
  if( lo == 2*1000000000 )cout << hi << endl ;
  else cout << lo << endl ;
