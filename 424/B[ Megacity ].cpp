...
<head>
    ...
    <meta name="X-Csrf-Token" content="48785a835b8d64d7b6eb122631b0e3fb"/>
    ...
    <meta property="og:title" content="Submission #10251522 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="7af00c3bb7dc9d7731a58dfb78ba550cf711709e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #10251522 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='48785a835b8d64d7b6eb122631b0e3fb'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F424%2Fsubmission%2F10251522">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='48785a835b8d64d7b6eb122631b0e3fb'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - Megacity" href="/contest/424/problem/B">424B</a>
    ...
    <td>2015-03-12 23:27:00</td>
    <td>2015-03-12 23:27:02</td>
    <td>
...
int main(){
    ...
    while( cin >> n >> s ){
        ...
        if( s+p < 1000000 ){
            ...
            sort( arr, arr+int(n) , comp ) ;
            for( int i = 0 ;i < int(n) ; i++ ){
                mx = max( mx , sqrt(arr[i].a*arr[i].a+arr[i].b*arr[i].b)) ;
                s+= arr[i].c ;
                if( s >=1000000 ){
