...
<head>
    ...
    <meta name="X-Csrf-Token" content="c178d4a9b70c5d1059f120f9ade75c42"/>
    ...
    <meta property="og:title" content="Submission #9912508 - Codeforces"/>
    ...
    <title>Submission #9912508 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='c178d4a9b70c5d1059f120f9ade75c42'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F499%2Fsubmission%2F9912508">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='c178d4a9b70c5d1059f120f9ade75c42'/>
...
int main() {
    ...
    while( cin >> n >> x ) {
        ...
        while( n -- ) {
            ...
            while( curr+x <= a )curr += x ;
            while( curr <= b )tot ++ , curr++ ;
        }
        cout << tot << endl ;
    }
