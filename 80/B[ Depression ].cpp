...
<head>
    ...
    <meta name="X-Csrf-Token" content="07cef1107ddc717a1d70befb9e6c718d"/>
    ...
    <meta property="og:title" content="Submission #11528886 - Codeforces"/>
    ...
    <title>Submission #11528886 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='07cef1107ddc717a1d70befb9e6c718d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F80%2Fsubmission%2F11528886">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='07cef1107ddc717a1d70befb9e6c718d'/>
...
int main() {
    ...
    double total = 0;
    total = (a%12)*60+b ;
    double H = (((double)360/12)/60)*total;
    double M = ((double)360/60)*b ;
    cout << H << " " << M << endl ;
