...
<head>
    ...
    <meta name="X-Csrf-Token" content="266d97b49dbf7eb64f5ded73d5406a1e"/>
    ...
    <meta property="og:title" content="Submission #10037893 - Codeforces"/>
    ...
    <title>Submission #10037893 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='266d97b49dbf7eb64f5ded73d5406a1e'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F230%2Fsubmission%2F10037893">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='266d97b49dbf7eb64f5ded73d5406a1e'/>
...
int main()
{
    ...
    for( int i = 0 ; i < prime.size() ; i++ ){
        st.insert( prime[i]*prime[i] ) ;
    }
    rep( i , n ) {
        long long p ;
        cin >> p ;
        if( st.find(p) != st.end() )cout << "YES\n" ;
        else cout << "NO\n" ;
    }
    return 0;
}
