...
<head>
    ...
    <meta name="X-Csrf-Token" content="ddeb0556ae42efa07defadca141d4a2a"/>
    ...
    <meta property="og:title" content="Submission #9827706 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="244348b4c57a4aee38bc47fd6325eff0dc8028a3"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #9827706 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ddeb0556ae42efa07defadca141d4a2a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F460%2Fsubmission%2F9827706">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ddeb0556ae42efa07defadca141d4a2a'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - Little Dima and Equation" href="/contest/460/problem/B">460B</a>
...
long long Pow( long long a , long long c ){
    long long q = 1 ;
    while( c-- ){
        q = q*a ;
    }
...
int main(){
    ...
    while(cin >> a  >> b >> c  ){
        ...
        for( int i = 1 ; i < 81 ; i++ ){
            ...
            if( i == tot && calc>0 && calc < 1000000000 )V.push_back(calc) ;
        }
        cout << V.size() << endl;
