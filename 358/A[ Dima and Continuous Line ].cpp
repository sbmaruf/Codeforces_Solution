...
<head>
    ...
    <meta name="X-Csrf-Token" content="746b6b8c53618515d37059612b25e6ed"/>
    ...
    <meta property="og:title" content="Submission #5091490 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="77f6f54dad52edba1c4cda30b3013dbe13abb54e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #5091490 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='746b6b8c53618515d37059612b25e6ed'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F358%2Fsubmission%2F5091490">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='746b6b8c53618515d37059612b25e6ed'/>
...
int main()
{
    ...
    {
        for(int k=i+1,l=i+2;l<n;){
            if(arr[k]<arr[i] && arr[l]>arr[i] && ((arr[k]>arr[j] && arr[l]>arr[j])||((arr[k]<arr[j] && arr[l]<arr[j]))))goto down;
            else if(arr[k]>arr[i] && arr[l]<arr[i] && ((arr[k]>arr[j] && arr[l]>arr[j])||((arr[k]<arr[j] && arr[l]<arr[j]))))goto down;
            else if(arr[k]<arr[j] && arr[l]>arr[j] && ((arr[k]>arr[i] && arr[l]>arr[i])||((arr[k]<arr[i] && arr[l]<arr[i])) ))goto down;
            else if(arr[k]>arr[j] && arr[l]<arr[j] && ((arr[k]>arr[i] && arr[l]>arr[i])||((arr[k]<arr[i] && arr[l]<arr[i]))))goto down;
            k++;
            l=k+1;
        }
        for(int k=i-1,l=i-2;l>=0;){
            if(arr[k]<arr[i] && arr[l]>arr[i] && ((arr[k]>arr[j] && arr[l]>arr[j])||((arr[k]<arr[j] && arr[l]<arr[j]))))goto down;
            else if(arr[k]>arr[i] && arr[l]<arr[i] && ((arr[k]>arr[j] && arr[l]>arr[j])||((arr[k]<arr[j] && arr[l]<arr[j]))))goto down;
            else if(arr[k]<arr[j] && arr[l]>arr[j] && ((arr[k]>arr[i] && arr[l]>arr[i])||((arr[k]<arr[i] && arr[l]<arr[i]))))goto down;
            else if(arr[k]>arr[j] && arr[l]<arr[j] && ((arr[k]>arr[i] && arr[l]>arr[i])||((arr[k]<arr[i] && arr[l]<arr[i]))))goto down;
