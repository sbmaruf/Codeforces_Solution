...
<head>
    ...
    <meta name="X-Csrf-Token" content="13d98c393b27a048c12371a44a436e0a"/>
    ...
    <meta property="og:title" content="Submission #11198746 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="22443d70fe40904575b7bef76f7d46c2c28dac5e"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11198746 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='13d98c393b27a048c12371a44a436e0a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F538%2Fsubmission%2F11198746">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='13d98c393b27a048c12371a44a436e0a'/>
...
int main() {
    ...
    if( arr[0].first != 1 )mx = max( mx , arr[0].first+arr[0].second - 1 ) ;
    for( int i = 1 ; i < m ; i++ ){
        int xdiff = arr[i].first-arr[i-1].first ;
        int ydiff = abs(arr[i].second-arr[i-1].second) ;
        if( ydiff > xdiff ){
            cout << "IMPOSSIBLE\n" ;
            return 0 ;
        }
        mx = max( mx , arr[i-1].second + (arr[i].first-arr[i-1].first+arr[i].second-arr[i-1].second)/2) ;
    }
    if( arr[m-1].first!= n )mx = max(mx , arr[m-1].second+(n-arr[m-1].first));
    cout << mx << endl ;
    return 0 ;
}
