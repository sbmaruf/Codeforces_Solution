...
<head>
    ...
    <meta name="X-Csrf-Token" content="dfdad3d27c424abf8ba3b8d36f731567"/>
    ...
    <meta property="og:title" content="Submission #13637508 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="df540ca15db1a19c9806a4c7cca0953fde89cb62"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #13637508 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='dfdad3d27c424abf8ba3b8d36f731567'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F588%2Fsubmission%2F13637508">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='dfdad3d27c424abf8ba3b8d36f731567'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-10-15 20:19:36</td>
    <td>2015-10-15 22:14:09</td>
    <td>
...
bool status[1000000+5] ;
vector<long long>prime;
void SOE(){
  prime.push_back(2) ;
  for( long long i = 3 ; i <= 1000000+5 ; i+= 2 ){
    if( status[i] == 0 ){
      prime.push_back(i) ;
      for( long long j = i*i ; j <= 1000000+5 ; j+= i+i ) {
        status[j] = 1 ;
      }
    }
  }
