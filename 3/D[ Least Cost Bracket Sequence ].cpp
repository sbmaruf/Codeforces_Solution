...
<head>
    ...
    <meta name="X-Csrf-Token" content="7974549e813c38f0db18b64492801d39"/>
    ...
    <meta property="og:title" content="Submission #20805512 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="a5f8cd396486da1a93667ee07e1279611ebf04a1"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #20805512 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7974549e813c38f0db18b64492801d39'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F3%2Fsubmission%2F20805512">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7974549e813c38f0db18b64492801d39'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="D - Least Cost Bracket Sequence" href="/contest/3/problem/D">3D</a>
...
struct node {
  long long w, idx ;
  node() {}
  node(int _w , int _idx ):w(_w),idx(_idx) {}
...
int main() {
  ...
  for( int i = 0 ; i < s.size() ; i++ ) {
    ...
    if( brackets < 0 ){
      ...
      pq.pop() ;
      s[tmp.idx] = &#39;(&#39; ;
      cost += (long long)tmp.w ;
      brackets++ ;
      brackets++ ;
    }
  }
  if( brackets != 0 )cout << "-1\n" ;
  else cout << cost << "\n" << s << "\n" ;
