...
<head>
    ...
    <meta name="X-Csrf-Token" content="68a5abea9235348b1509b2c1fd8237fe"/>
    ...
    <meta property="og:title" content="Submission #10038303 - Codeforces"/>
    ...
    <title>Submission #10038303 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='68a5abea9235348b1509b2c1fd8237fe'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F3%2Fsubmission%2F10038303">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='68a5abea9235348b1509b2c1fd8237fe'/>
...
int main()
{
    string s,s1 ;
    while( cin >> s >> s1 ){
        cout << max(abs(int(s[0]-s1[0])),abs(int(s[1]-s1[1])))<<endl ;
