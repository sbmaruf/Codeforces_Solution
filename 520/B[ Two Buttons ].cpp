...
<head>
    ...
    <meta name="X-Csrf-Token" content="7db42adb80cea31c5e6f1209960696ed"/>
    ...
    <meta property="og:title" content="Submission #11199268 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="23d6fbb28af58f8fd714082c616b6cd6b4320ed4"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11199268 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7db42adb80cea31c5e6f1209960696ed'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F520%2Fsubmission%2F11199268">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7db42adb80cea31c5e6f1209960696ed'/>
...
int dist[1000000+1] ;
int dijkstra( int n ){
    for( int i = 0 ; i < 1000000+1 ; i++ )dist[i]= 1<<30 ;
    ...
    while( !pq.empty() ){
        ...
        if( u.u >=1 && u.u < 500000 ) {
            if(u.w+1 < dist[u.u-1] ){
                dist[u.u-1] = u.w+1 ;
                pq.push(node(u.u-1,dist[u.u-1])) ;
            }
            if(u.w+1 < dist[2*u.u] ){
                dist[2*u.u] = u.w+1 ;
                pq.push(node(2*u.u,dist[2*u.u])) ;
            }
        }
    }
}
