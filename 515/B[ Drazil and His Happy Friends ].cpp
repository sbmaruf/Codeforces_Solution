...
<head>
    ...
    <meta name="X-Csrf-Token" content="5ec9c135d3689bed57e781665be089cf"/>
    ...
    <meta property="og:title" content="Submission #9903951 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="72ae2fc1b4f0cae22fc8e95a4c986c02d06956ff"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #9903951 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5ec9c135d3689bed57e781665be089cf'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F515%2Fsubmission%2F9903951">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5ec9c135d3689bed57e781665be089cf'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - Drazil and His Happy Friends" href="/contest/515/problem/B">515B</a>
    ...
    <td>2015-02-17 22:15:15</td>
    <td>2015-02-17 22:15:16</td>
    <td>
...
int main() {
    ...
    while( cin >> n >> m ) {
        ...
        long long FUCKLIMIT = 1000000 ;
        for( int i = 0 ; i < FUCKLIMIT ; i++ ) {
            int boy =i%n;
            int girl =i%m;
            if(mp1.find(girl)!= mp1.end() && mp.find(boy)== mp.end() ) {
                mp[boy]++ ;
                mp1[girl]++ ;

            }else if( mp1.find(girl)== mp1.end() && mp.find(boy)!= mp.end() ) {
                mp[boy]++ ;
                mp1[girl]++ ;
            }
