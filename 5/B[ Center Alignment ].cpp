...
<head>
    ...
    <meta name="X-Csrf-Token" content="63cfb7c0b2eb269e385f93265acc5210"/>
    ...
    <meta property="og:title" content="Submission #12711728 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="738e596241b3018f832cf18479fdf228f2c957f9"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12711728 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='63cfb7c0b2eb269e385f93265acc5210'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F5%2Fsubmission%2F12711728">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='63cfb7c0b2eb269e385f93265acc5210'/>
...
int main() {
  ...
  for( int i  = 0; i < idx ; i++ ) {
    ...
    int rem = mx-s[i].size()-2 ;
    int tmp ;
    if( rem & 1 ){
      if(f)tmp = rem/2,f=0 ;
      else tmp = rem/2+1,f=1;
    }else tmp = rem/2 ;
