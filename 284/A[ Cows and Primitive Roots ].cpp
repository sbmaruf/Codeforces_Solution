...
<head>
    ...
    <meta name="X-Csrf-Token" content="42b9f1e0f34fd2332f6b03b693bf4b1b"/>
    ...
    <meta property="og:title" content="Submission #15964111 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="18e58cdd47a403eab7cf4b7015e6ed0282a82d2d"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #15964111 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='42b9f1e0f34fd2332f6b03b693bf4b1b'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F284%2Fsubmission%2F15964111">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='42b9f1e0f34fd2332f6b03b693bf4b1b'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Cows and Primitive Roots" href="/contest/284/problem/A">284A</a>
...
long long Pow( long long n , long long b , long long mod ) {
  if( b == 0 )return 1LL ;
  else if( b == 1LL ) return n ;
  if( b&1LL ) {
    return (n*(Pow(n,b-1,mod))%mod) ;
  } else {
    long long tmp = Pow(n,b/2,mod) ;
    return (tmp*tmp)%mod ;
  }
}
