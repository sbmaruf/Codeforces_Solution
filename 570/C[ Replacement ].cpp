...
<head>
    ...
    <meta name="X-Csrf-Token" content="cf9e992e6f431b3ac45a8875a9284759"/>
    ...
    <meta property="og:title" content="Submission #18606137 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="e43f975fc9a7d4b37a81fcf41b29ec0bc681f521"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #18606137 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cf9e992e6f431b3ac45a8875a9284759'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F570%2Fsubmission%2F18606137">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cf9e992e6f431b3ac45a8875a9284759'/>
...
struct box {
  ...
  box( int _l , int _m , int _r ) {
    left = _l , right = _r , mid = _m ;
  }
};
box arr[7000] ;
int lastboxlength = 0 , l ;
long long bn ;
int getBox( int n ) {
  return n/bn ;
}
...
void update(int i) {
  long long left = 0 , right = 0 , mid = 0 , cnt = 0;
  int j = i , k = 0 ;
  while( s[j] == &#39;.&#39; && k < bn ) j++ , k++ ;
  left = k ;
  if( k != bn ) {
  ...
  int idx = getBox(i) ;
  arr[idx] = box(left,mid,right) ;
}
long long query() {
  long long ret = 0 , bc = 0 ;
  for( int i = 0 ; i < l ; i+= bn ) {
    int idx = getBox(i) ;
    bc += arr[idx].left ;
    if( arr[idx].left == bn ) continue ;
    if( bc > 0 ) ret += (bc-1) ;
    bc = arr[idx].right ;
    ret += arr[idx].mid ;
  }
