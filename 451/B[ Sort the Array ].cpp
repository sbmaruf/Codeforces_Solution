...
<head>
    ...
    <meta name="X-Csrf-Token" content="9fa705b81ba985c4ca992605d02d6196"/>
    ...
    <meta property="og:title" content="Submission #7227090 - Codeforces"/>
    ...
    <title>Submission #7227090 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9fa705b81ba985c4ca992605d02d6196'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F451%2Fsubmission%2F7227090">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9fa705b81ba985c4ca992605d02d6196'/>
...
<a href="/profile/_kryptonyte_" title="Newbie _kryptonyte_" class="rated-user user-gray">_kryptonyte_</a>    </td>
    ...
    <td>2014-07-24 20:32:49</td>
    <td>2014-07-24 21:35:00</td>
    <td>
...
int main()
{
    ...
    arr[0] = (1000000000+1)*-1 ;
    rep_1( i , n+1 )cin >> arr[i] ;
    pii ans ;
    {
        int A = 1 ;
        for( int i = 2 ; i < n+1 ; i++ ) {
