...
<head>
    ...
    <meta name="X-Csrf-Token" content="e50d7438bb69b117a14c4e6c14f95de5"/>
    ...
    <meta property="og:title" content="Submission #7797959 - Codeforces"/>
    ...
    <title>Submission #7797959 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e50d7438bb69b117a14c4e6c14f95de5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F448%2Fsubmission%2F7797959">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e50d7438bb69b117a14c4e6c14f95de5'/>
...
int main()
{
    ...
    int d ;
    cin >>d ;
    if( (int(ceil(sum1/5.0)) + int(ceil(sum2/10.0)))> d )cout << "NO\n" ;
    else cout << "YES\n" ;
