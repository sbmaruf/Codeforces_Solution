...
<head>
    ...
    <meta name="X-Csrf-Token" content="5cd3510281375253866b68bd2daf18d8"/>
    ...
    <meta property="og:title" content="Submission #12713690 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="b27af159dc111f51b9db46256481176fcfff4c50"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12713690 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5cd3510281375253866b68bd2daf18d8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F302%2Fsubmission%2F12713690">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5cd3510281375253866b68bd2daf18d8'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-08-27 02:27:40</td>
    <td>2015-08-27 02:27:39</td>
    <td>
...
int main() {
  ...
  while( cin >> n >> m ) {
    ...
    for( int i = 0 ; i < m ; i++ ) {
      ...
      cin >> l >> r ;
      if((r-l+1)&1)cout <<0<<"\n";
      else if( cnt1>=((r-l+1)>>1) && (cnt2 >= ((r-l+1)>>1)))cout << "1\n" ;
      else cout << "0\n" ;
    }
