...
<head>
    ...
    <meta name="X-Csrf-Token" content="1f57c9eb65c8470a965a05c2732c7cb5"/>
    ...
    <meta property="og:title" content="Submission #7814953 - Codeforces"/>
    ...
    <title>Submission #7814953 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1f57c9eb65c8470a965a05c2732c7cb5'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F320%2Fsubmission%2F7814953">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1f57c9eb65c8470a965a05c2732c7cb5'/>
...
int main(){
     ...
     for( int i = 0 ;i < s.size() ; i++ ){
         if( i == 0 ){
             ...
             if( s[i] == &#39;1&#39; )continue ;
             else if( s[i] == &#39;4&#39; && s[i-1] == &#39;1&#39; )continue ;
             else{
                 cout << "NO\n";
                 return 0 ; 
             }
