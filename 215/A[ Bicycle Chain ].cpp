...
<head>
    ...
    <meta name="X-Csrf-Token" content="8aa48ff8f7b62e8248f3b797199a48cd"/>
    ...
    <meta property="og:title" content="Submission #11320773 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="eac358dd6834a840b72dc128c5553dd5f6a16995"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #11320773 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='8aa48ff8f7b62e8248f3b797199a48cd'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F215%2Fsubmission%2F11320773">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='8aa48ff8f7b62e8248f3b797199a48cd'/>
...
int main() {
    ...
    while( cin >> n  ) {
        ...
        rep( i ,n ) {
            rep( j , m ) {
                if( A[j]%a[i] == 0 )mx = max(mx , A[j]/a[i] ) ;
            }
        }
        int cnt = 0  ;
        rep( i ,n ) {
            rep( j , m ) {
                if( A[j]%a[i] == 0 && (A[j]/a[i]) == mx )cnt ++ ;
            }
        }
        cout << cnt << endl ;
    }
