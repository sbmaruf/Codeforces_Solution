...
<head>
    ...
    <meta name="X-Csrf-Token" content="cc1ade6defba1bebb08213bb03539ab9"/>
    ...
    <meta property="og:title" content="Submission #8090631 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="e86d60f2bd55bcb8a6fdd9511b3e8fdf004c1593"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #8090631 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='cc1ade6defba1bebb08213bb03539ab9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F475%2Fsubmission%2F8090631">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='cc1ade6defba1bebb08213bb03539ab9'/>
...
<ul class="second-level-menu-list">
        <li><a
                                        href="/contest/475">Problems</a></li>
        <li><a
                                        href="/contest/475/submit">Submit Code</a></li>
        <li><a
                                        href="/contest/475/my">My Submissions</a></li>
        <li class="current selectedLava"><a
                                        href="/contest/475/status">Status</a></li>
        <li><a
                                        href="/contest/475/hacks">Hacks</a></li>
        <li><a
                                        href="/contest/475/room/1">Room</a></li>
        <li><a
                                        href="/contest/475/standings">Standings</a></li>
        <li><a
                                        href="/contest/475/customtest">Custom Invocation</a></li>
</ul>
</div>
...
<a href="/profile/_kryptonyte_" title="Pupil _kryptonyte_" class="rated-user user-green">_kryptonyte_</a>    </td>
    <td>
        <a title="A - Bayan Bus" href="/contest/475/problem/A">475A</a>
    ...
    <td>2014-10-05 17:55:26</td>
    <td>2014-10-05 20:25:01</td>
    <td>
...
int main()
{
    ...
    for( int i = 1 ; i <= 4 ; i++ ) {
        ...
        //cout << cnt << endl ;
        bool ff = 0 ;
        for( int l = cnt ; l <11 ; l++ ) {
            if( i != 3 )cout <<"#.";
            else if( i == 3 && cnt == 0 && ff == 0 ) {
                cout << "#." ;
                ff =1 ;
