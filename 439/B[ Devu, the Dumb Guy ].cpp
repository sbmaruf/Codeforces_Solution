...
<head>
    ...
    <meta name="X-Csrf-Token" content="b99e32e54b1fb42e2e8f1894560579d3"/>
    ...
    <meta property="og:title" content="Submission #6813149 - Codeforces"/>
    ...
    <title>Submission #6813149 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='b99e32e54b1fb42e2e8f1894560579d3'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F439%2Fsubmission%2F6813149">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='b99e32e54b1fb42e2e8f1894560579d3'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2014-06-04 23:16:09</td>
    <td>2014-06-04 23:16:10</td>
    <td>
...
int main()
{
    ...
    while( cin >> n >> x ){
        ...
        long long int ans = 0 ;
        for( int i = 0 ; i< n ; i ++ ){
            ans += ((long long int )arr[i]) *(long long int ) x ;
            if( x >1 )x-- ;
        }
        cout << ans << endl ;
