...
<head>
    ...
    <meta name="X-Csrf-Token" content="ba37ccfe40778541ac46bc5f8aa57df9"/>
    ...
    <meta property="og:title" content="Submission #18295025 - Codeforces"/>
    ...
    <title>Submission #18295025 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='ba37ccfe40778541ac46bc5f8aa57df9'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F493%2Fsubmission%2F18295025">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='ba37ccfe40778541ac46bc5f8aa57df9'/>
...
int main(){
    ...
    for( int i = 0 ;i < n ; i++ ){
        ...
        else v1.push_back(abs(p)) ;
        v2.push_back(p) ;
        if( p >= 0 )s+=p ;
        else s1+=abs(p) ;
    }
    if( s>s1 )cout << "first\n" ;
    else if( s1>s ) cout << "second\n" ;
    else if( v > v1 )cout << "first\n" ;
    else if( v1 > v )cout << "second\n" ;
    else {
        if( v2.back()>= 0 ) cout << "first\n" ;
        else cout << "second\n" ;
    }
    return 0 ;
}
