...
<head>
    ...
    <meta name="X-Csrf-Token" content="7ce8c81f1aa4852f50386a5aed9b8099"/>
    ...
    <meta property="og:title" content="Submission #7805925 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="d09e6f53b62079e0e03d6d6f7d7bda255760fde4"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #7805925 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='7ce8c81f1aa4852f50386a5aed9b8099'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F1%2Fsubmission%2F7805925">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='7ce8c81f1aa4852f50386a5aed9b8099'/>
...
int main()
{
    ...
    while( n -- ){
        ...
        for( int i = 0 ;i < s.size() ; i++ ){
            if( s[i]>=&#39;A&#39; && s[i]<=&#39;Z&#39; && b == 1 )b = 1 ;
            if( s[i]>=&#39;0&#39; && s[i]<=&#39;9&#39; && b == 1 ){
                b = 2 ;
                flag++;
            }if( s[i]>=&#39;0&#39; && s[i]<=&#39;9&#39; && b == 2 ){
                b = 2 ;
            }else if( s[i]>=&#39;A&#39; && s[i]<=&#39;Z&#39; && b == 2 ){
                b =1 ;
                flag ++ ;
            }
        }
        ...
        if( flag!=3 ){
            ...
            cout << "C" ;
            long long int q = 0 ;
            for( int i = p.size()-1,j=1 ; i>=0 ; i--,j*=26 ){
                long long int z = p[i]-&#39;A&#39;+1 ;
                long long a = ((z)*(j)) ;
                q += a ;
            }
            cout << q <<endl ;
            ...
            int i,j ;
            int q =0;
            for( i = s.size()-1,j=1 ; !(s[i] >=&#39;A&#39;&& s[i]<=&#39;Z&#39;) ; i--,j*=10 ){
                q+= ((s[i]-&#39;0&#39;)*j);
            }
            //cout << q <<endl ;
            string z ;
            ...
            q =0;
            //cout << s[i] << endl;
            for( i = i-1,j=1 ; !(s[i] >=&#39;A&#39;&& s[i]<=&#39;Z&#39;) ; i-- , j*=10){
                 q+= ((s[i]-&#39;0&#39;)*j);
            }
            cout << z << q << endl ;
        }
