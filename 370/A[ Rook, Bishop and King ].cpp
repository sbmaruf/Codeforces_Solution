...
<head>
    ...
    <meta name="X-Csrf-Token" content="1ff3ae68206068e5c1b66490f28b1784"/>
    ...
    <meta property="og:title" content="Submission #13060061 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="e4507134965b13f6a4505d812d2bc5417e086e21"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #13060061 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1ff3ae68206068e5c1b66490f28b1784'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F370%2Fsubmission%2F13060061">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1ff3ae68206068e5c1b66490f28b1784'/>
...
int main() {
  ...
  cin >> r1 >> c1 >> r2 >> c2 ;
  int ans = 0 ;
  if( ((r1+c1) &1) ^ ((r2+c2)&1)==0 ) {
    if( abs(r1-r2)==abs(c1-c2) )ans = 1 ;
    else ans =2 ;
  }else ans = 0 ;
  cout << ((r1 == r2 || c1 == c2 )? 1 : 2 )<< " " << ans << " " << max(abs( r2-r1 ) , abs( c2-c1 )) << "\n" ;
  return 0 ;
}
