...
<head>
    ...
    <meta name="X-Csrf-Token" content="6e2d7b5f57caf013a66c7c2e04a2b745"/>
    ...
    <meta property="og:title" content="Submission #7715320 - Codeforces"/>
    ...
    <title>Submission #7715320 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='6e2d7b5f57caf013a66c7c2e04a2b745'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F463%2Fsubmission%2F7715320">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='6e2d7b5f57caf013a66c7c2e04a2b745'/>
...
int main(){
    ...
    for( int i = 0 ; i < n ; i++ ){
        ...
        if( arr[i].first == s ){
            ...
            MAX = max( MAX , (100- arr[i].second)%100 ) ;
        }
