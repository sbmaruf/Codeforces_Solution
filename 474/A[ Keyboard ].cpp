...
<head>
    ...
    <meta name="X-Csrf-Token" content="59472ae61943b104bba493f5715f3f37"/>
    ...
    <meta property="og:title" content="Submission #9126682 - Codeforces"/>
    ...
    <title>Submission #9126682 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='59472ae61943b104bba493f5715f3f37'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F474%2Fsubmission%2F9126682">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='59472ae61943b104bba493f5715f3f37'/>
...
int main()
{
    ...
    for(int i = 0 ; i < 3 ; i++ ) {
        for( int j = 0 ; j < tmp[i].size() ; j++ ) {
            if(j == 0 ) {
                mp1[tmp[i][j]]=tmp[i][j] ;
                mp2[tmp[i][j]]=tmp[i][j+1] ;
            } else if( j == tmp[i].size()-1 ) {
                mp1[tmp[i][j]]=tmp[i][j-1] ;
                mp2[tmp[i][j]]=tmp[i][j] ;
            } else {
                mp1[tmp[i][j]]=tmp[i][j-1] ;
                mp2[tmp[i][j]]=tmp[i][j+1] ;
