...
<head>
    ...
    <meta name="X-Csrf-Token" content="a463141bc88fe2add939ddf33e52d62a"/>
    ...
    <meta property="og:title" content="Submission #6641548 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="08a455af1f7747b6d4e531fe5172608bada8e83b"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #6641548 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='a463141bc88fe2add939ddf33e52d62a'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F202%2Fsubmission%2F6641548">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='a463141bc88fe2add939ddf33e52d62a'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - Brand New Easy Problem" href="/contest/202/problem/B">202B</a>
...
int main()
{
    ...
    int p ;
    cin >> p ;
    int invertion = numeric_limits<int>::max() ;
    int index = -1 ;
    rep( a , p ) {
        int l ;
        cin >> l ;
                    ...
                    if( i != j ) {
                        rep( k , l ) {
                            if( k != i && k != j ) {
                                rep( m , l ) {
                                    if( m != i && m != j && m != k ) {
                                        if( V1[i] == V[0] && V1[j] == V[1] && V1[k] == V[2] && V1[m] == V[3] ) {
                                            int inv = 0 ;
                                            if( i > j ) inv++ ;
                                            if( i > k ) inv++ ;
                                            if( i > m ) inv++ ;
    ...
    int m = n * ( n- 1 ) / 2 - invertion + 1 ;

    if( index == -1 )cout << "Brand new problem!" << endl ;
    else {
        cout << index + 1 << endl << "[:" ;
        rep( i ,  m )cout << "|" ;
        cout << ":]" ;
