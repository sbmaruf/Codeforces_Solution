...
<head>
    ...
    <meta name="X-Csrf-Token" content="47ceb6f5077243ddff5e8b22b6237419"/>
    ...
    <meta property="og:title" content="Submission #12190246 - Codeforces"/>
    ...
    <title>Submission #12190246 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='47ceb6f5077243ddff5e8b22b6237419'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F560%2Fsubmission%2F12190246">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='47ceb6f5077243ddff5e8b22b6237419'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="D - Equivalent Strings" href="/contest/560/problem/D">560D</a>
...
string Solve(string s ){
  ...
  string b=Solve( s.substr(s.size()/2,s.size()));
  if( a < b ) return a+b ;
  else return b+a ;
}
