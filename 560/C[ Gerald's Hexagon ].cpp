...
<head>
    ...
    <meta name="X-Csrf-Token" content="17a10dbd5294c2e1906fc20aa8150646"/>
    ...
    <meta property="og:title" content="Submission #12263268 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="06d66f929734b40682d76acffc9b9e239d0e0a59"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #12263268 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='17a10dbd5294c2e1906fc20aa8150646'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F560%2Fsubmission%2F12263268">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='17a10dbd5294c2e1906fc20aa8150646'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <pre class="prettyprint lang-cpp program-source" style="padding: 0.5em;">#include<stdio.h>
#include<iostream>
#include<vector>
#include<string>
#include<string.h>
...
double arm( double p , double q ){
  return sqrt( p*p + q*q - 2*p*q*cos(120*acos(-1.0)/180) ) ;
}
...
int main() {
  ...
  double area = tri( a , b , aa ) + tri( c , d , bb ) + tri( e , f , cc ) + tri( aa,bb,cc) ;
  //cout << area << endl ;
  //cout << double( area ) / (double) tri(1,1,1) << endl ;
  cout << int( (area / tri(1,1,1)) + 1e-7 ) << endl ;
  return 0 ;
