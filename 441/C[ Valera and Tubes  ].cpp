...
<head>
    ...
    <meta name="X-Csrf-Token" content="d40be242a93f10241292f6317bf7535c"/>
    ...
    <meta property="og:title" content="Submission #12734232 - Codeforces"/>
    ...
    <title>Submission #12734232 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='d40be242a93f10241292f6317bf7535c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F441%2Fsubmission%2F12734232">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='d40be242a93f10241292f6317bf7535c'/>
...
int n , m , k ;
int vis[301][301] ;
void dfs( int i , int j , int t , int d , int idx , bool f ) {
  if( t == tot && f == 0 ) {
    if( i+j>0 ) cout << "\n" ;
    t = 0 ;
    idx++ ;
    if( idx == k )f = 1 ;
    if( idx < k )cout << tot ;
    else cout << n*m-(k-1)*tot ; ;
  } ;
  vis[i][j] = 1 ;
  //cout << " " << i+1 << " " << j+1 << " " << t << " " << d << " " << idx << " " << f    ;
  cout << " " << i+1 << " " << j+1 ;
  t++ ;
  if( d == 0 ) {
...
//        cout << " " << V[i][j].first+1 << " " << V[i][j].second+1  ;
//      }cout << "\n" ;
//    }
  }
  return 0 ;
