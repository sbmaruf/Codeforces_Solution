...
<head>
    ...
    <meta name="X-Csrf-Token" content="30d800b7096645b54a4a6e00d55edcb2"/>
    ...
    <meta property="og:title" content="Submission #13060164 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="90f241869b5dfcb1e3fcfa6c4299c20d2e7b72d0"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #13060164 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='30d800b7096645b54a4a6e00d55edcb2'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F49%2Fsubmission%2F13060164">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='30d800b7096645b54a4a6e00d55edcb2'/>
...
int main() {
  ...
  while( !(s[s.size()-1] >= &#39;a&#39; && s[s.size()-1] <= &#39;z&#39;) ){
    s.pop_back() ;
  }
  char ch = s[s.size()-1] ;
