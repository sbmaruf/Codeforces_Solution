...
<head>
    ...
    <meta name="X-Csrf-Token" content="1c0d6bdab62667faa1c267b24498bfa6"/>
    ...
    <meta property="og:title" content="Submission #9918719 - Codeforces"/>
    ...
    <title>Submission #9918719 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='1c0d6bdab62667faa1c267b24498bfa6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F489%2Fsubmission%2F9918719">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='1c0d6bdab62667faa1c267b24498bfa6'/>
...
int main() {
    ...
    while( cin >> n ) {
        ...
        rep( i , n )cin >> b[i].second , b[i].first = i ;

        int m ;
        cin >> m ;
        pi g[m] ;

        rep( i  , m )cin >> g[i].y , g[i].x = i  ;
