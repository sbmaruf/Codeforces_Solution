...
<head>
    ...
    <meta name="X-Csrf-Token" content="e27fc3a21a93d848d9f4917c8becb7a7"/>
    ...
    <meta property="og:title" content="Submission #9827686 - Codeforces"/>
    ...
    <title>Submission #9827686 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e27fc3a21a93d848d9f4917c8becb7a7'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F160%2Fsubmission%2F9827686">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e27fc3a21a93d848d9f4917c8becb7a7'/>
...
int main(){
    ...
    while( cin >> n ) {
        ...
        cin >> s ;
        int i  ;
        for( i = 0 ; i<n ; i++ )t1+=s[i] ;
        for( i = i ; i<s.size() ; i++ )t2+=s[i] ;
