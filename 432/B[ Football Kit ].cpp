...
<head>
    ...
    <meta name="X-Csrf-Token" content="745821e175190e4d96433077fced9de6"/>
    ...
    <meta property="og:title" content="Submission #6636302 - Codeforces"/>
    ...
    <title>Submission #6636302 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='745821e175190e4d96433077fced9de6'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F432%2Fsubmission%2F6636302">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='745821e175190e4d96433077fced9de6'/>
...
int main()
{
    ...
    for( int i = 0 ; i < n ; i++ ){
        int ans1 = n-1+home[pi[i].second] ;
        int ans2 = n-1-home[pi[i].second] ;
        cout << ans1 << " " << ans2 << endl ;
    }
