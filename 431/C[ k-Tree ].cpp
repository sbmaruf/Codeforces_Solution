...
<head>
    ...
    <meta name="X-Csrf-Token" content="da796074ec09aa6e55b13eeae29dca4f"/>
    ...
    <meta property="og:title" content="Submission #12710224 - Codeforces"/>
    ...
    <title>Submission #12710224 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='da796074ec09aa6e55b13eeae29dca4f'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F431%2Fsubmission%2F12710224">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='da796074ec09aa6e55b13eeae29dca4f'/>
...
long long rec( int sum , bool perm ) {
  if( sum > n )return 0 ;
  if( sum == n && perm )return 1 ;
  if( dp[sum][perm] != -1 ) return dp[sum][perm] ;
  long long ret = 0 ;
  for( int i = 1; i <= k ; i++ ) {
    ret += rec( sum+i , perm||(i>=d) ) ;
    ret %= MOD ;
  }
  return dp[sum][perm] = ret%MOD ;
}
