...
<head>
    ...
    <meta name="X-Csrf-Token" content="2fa14ef90443911ce33250036ff94f7c"/>
    ...
    <meta property="og:title" content="Submission #10254463 - Codeforces"/>
    ...
    <title>Submission #10254463 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2fa14ef90443911ce33250036ff94f7c'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F476%2Fsubmission%2F10254463">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2fa14ef90443911ce33250036ff94f7c'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-03-13 10:11:12</td>
    <td>2015-03-13 10:11:26</td>
    <td>
...
string s,s1 ;
int dp[100][100] ;
double rec( int pos , int val ){

    if( pos == s1.size() ){
        return  val == tot ;
    }
    if( dp[pos][val] != -1) return dp[pos][val] ;
    if( s1[pos] == &#39;+&#39; )dp[pos][val] = rec( pos+1 , val+1 );
    else if( s1[pos] == &#39;-&#39; ) dp[pos][val] = rec( pos+1 , val-1 ) ;
    else {
        dp[pos][val] = rec( pos+1 , val+1 )+rec( pos+1 , val-1 ) ;
    }
    return dp[pos][val] ;
}


double rec1( int pos , int val ){

    if( pos == s1.size() ){
        return  val != tot ;
    }
    if( dp[pos][val] != -1) return dp[pos][val] ;
    if( s1[pos] == &#39;+&#39; )dp[pos][val] = rec1( pos+1 , val+1 );
    else if( s1[pos] == &#39;-&#39; ) dp[pos][val] = rec1( pos+1 , val-1 ) ;
    else {
        dp[pos][val] = rec1( pos+1 , val+1 )+rec1( pos+1 , val-1 ) ;
    }
    return dp[pos][val] ;
}
