...
<head>
    ...
    <meta name="X-Csrf-Token" content="e2b82e4ed84a0719465c268a9d813256"/>
    ...
    <meta property="og:title" content="Submission #13180774 - Codeforces"/>
    ...
    <title>Submission #13180774 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='e2b82e4ed84a0719465c268a9d813256'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F580%2Fsubmission%2F13180774">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='e2b82e4ed84a0719465c268a9d813256'/>
...
<tr>
    ...
    <td>
            Virtual:<br/>
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a><sup style='margin-left: 0.25em;font-size: 8px;' title="Virtual participant"><a href='/contest/580/standings/participant/5690719#p5690719'>#</a></sup>    </td>
    <td>
        <a title="D - Kefa and Dishes" href="/contest/580/problem/D">580D</a>
    ...
    <td>2015-09-23 11:23:50</td>
    <td>2015-09-23 11:48:24</td>
    <td>
...
long long rec( int mask , int last ){
    ...
    for( int i = 1 ; i <= n ; i++ ){
        if( (mask&(1<<i))==0 ){
            ret = max( ret , rec(mask|(1<<i),i)+a[i]+mp[last][i] ) ;
        }
    }
...
int main() {
    ...
    for( int i = 1 ; i<= n ; i++ ){
        //memset( dp , -1 , sizeof dp ) ;
        ans = max( ans , rec( mask|(1<<i) , i )+a[i] ) ;
    }
    cout << ans << "\n" ;
    return 0 ;
}
