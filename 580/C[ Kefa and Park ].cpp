...
<head>
    ...
    <meta name="X-Csrf-Token" content="5556d3be13401134e055738b29a8cda8"/>
    ...
    <meta property="og:title" content="Submission #13180609 - Codeforces"/>
    ...
    <title>Submission #13180609 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='5556d3be13401134e055738b29a8cda8'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F580%2Fsubmission%2F13180609">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='5556d3be13401134e055738b29a8cda8'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a><sup style='margin-left: 0.25em;font-size: 8px;' title="Virtual participant"><a href='/contest/580/standings/participant/5690719#p5690719'>#</a></sup>    </td>
    ...
    <td>2015-09-23 11:10:21</td>
    <td>2015-09-23 11:19:13</td>
    <td>
...
int arr[100000+5] ;
int vis[100000+5] ;
int dfs( int node , int cnt , int bc ) {
    ...
    for( int i = 0 ;i < g[node].size() ; i++ ){
       if( g[node][i] == bc )continue ;
       if( vis[g[node][i]] == 1 ) continue;
       ret += dfs(g[node][i] , cnt , node ) ;
    }
    return ret ;
}
