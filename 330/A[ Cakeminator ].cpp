...
<head>
    ...
    <meta name="X-Csrf-Token" content="40c9b6e3e0bafd375771f8a2e70c3d97"/>
    ...
    <meta property="og:title" content="Submission #7805109 - Codeforces"/>
    ...
    <title>Submission #7805109 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='40c9b6e3e0bafd375771f8a2e70c3d97'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F330%2Fsubmission%2F7805109">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='40c9b6e3e0bafd375771f8a2e70c3d97'/>
...
int main()
{
    ...
    for( int i = 0 ; i < n ; i++ ) {
        ...
        if( !f1 ) {
            cnt = 0 ;
            for( int  j = 0 ; j < m ; j++ ) {
                if( arr[i][j] == &#39;.&#39; && vis[i][j] == 0 )vis[i][j] = 1 , cnt ++ ;
            }
            sum +=cnt ;
        }
    }
    for( int i = 0 ; i < m ; i++ ) {
        ...
        if( !f1 ) {
            cnt = 0 ;
            for( int  j = 0 ; j < n ; j++ ) {
                if( arr[j][i] == &#39;.&#39; && vis[j][i] == 0 )vis[j][i] = 1 , cnt ++ ;
            }
            sum +=cnt;
        }
    }
