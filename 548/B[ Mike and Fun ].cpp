...
<head>
    ...
    <meta name="X-Csrf-Token" content="9412ed4231033349659b64088aef4976"/>
    ...
    <meta property="og:title" content="Submission #11290829 - Codeforces"/>
    ...
    <title>Submission #11290829 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='9412ed4231033349659b64088aef4976'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F548%2Fsubmission%2F11290829">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='9412ed4231033349659b64088aef4976'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    <td>
        <a title="B - Mike and Fun" href="/contest/548/problem/B">548B</a>
    ...
    <td>2015-05-26 20:22:36</td>
    <td>2015-05-26 21:53:15</td>
    <td>
...
int main() {
    ...
    for( int i = 0; i < q ; i++ ) {
        ...
        M[a] = mx ;
        global_max = 0 ;
        for( int j = 0 ; j< n ; j++ )global_max = max( M[j] , global_max ) ;
        cout << global_max << "\n" ;
    }
    return 0 ;
