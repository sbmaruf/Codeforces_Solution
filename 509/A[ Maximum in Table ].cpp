...
<head>
    ...
    <meta name="X-Csrf-Token" content="2741bf3611e9b50af31e8780bed121ba"/>
    ...
    <meta property="og:title" content="Submission #9912183 - Codeforces"/>
    ...
    <title>Submission #9912183 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='2741bf3611e9b50af31e8780bed121ba'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F509%2Fsubmission%2F9912183">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='2741bf3611e9b50af31e8780bed121ba'/>
...
int main() {
    ...
    cin >> n ;
    int arr[n+1][n+1] ;
    for( int i = 1 ; i <= n ; i++ )arr[1][i] = 1, arr[i][1] = 1 ;
