...
<head>
    ...
    <meta name="X-Csrf-Token" content="804c44dda7dc5edb8b5e7eab478f247d"/>
    ...
    <meta property="og:title" content="Submission #9837656 - Codeforces"/>
    <meta property="og:description" content=""/>
    
    <meta property="og:site_name" content="Codeforces"/>
    
    
    <meta name="cc" content="21dfe9790122aad73ea655ae75ea9ddaf82b87de"/>
    
    
    <meta name="utc_offset" content="+03:00"/>
    <meta name="verify-reformal" content="f56f99fd7e087fb6ccb48ef2" />
    <title>Submission #9837656 - Codeforces</title>
...
<body><span style='display:none;' class='csrf-token' data-csrf='804c44dda7dc5edb8b5e7eab478f247d'>&nbsp;</span>
...
<div id="header" style="position: relative;">
    ...
    <div class="lang-chooser">
        ...
        <div >
                        <a href="/enter?back=%2Fcontest%2F514%2Fsubmission%2F9837656">Enter</a>
                     | 
    ...
    <ul class="menu-list main-menu-list">
        ...
        <form method="post" action="/search"><input type='hidden' name='csrf_token' value='804c44dda7dc5edb8b5e7eab478f247d'/>
...
<a href="/profile/_kryptonyte_" title="Specialist _kryptonyte_" class="rated-user user-cyan">_kryptonyte_</a>    </td>
    ...
    <td>2015-02-14 20:01:51</td>
    <td>2015-02-14 21:52:02</td>
    <td>
...
int main() {
    ...
    while( cin >> n >> X >> Y ) {
        ...
        for( int i = 0 ; i  < n ; i++ ) {
            if( a[i] == 0 ) {
                Pair res = TanOfLine( q , p[i] ) ;
                a[i] = 1 ;
                cnt ++ ;
                for( int k = 0 ; k < n ; k++ ) {
                    Pair tmp = TanOfLine( q , p[k] );
